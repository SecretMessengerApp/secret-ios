...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.textColor = [UIColor wr_colorFromColorScheme:ColorSchemeColorTextForeground variant:ColorSchemeVariantLight];
        self.tintColor = [UIColor wr_colorFromColorScheme:ColorSchemeColorTextForeground variant:ColorSchemeVariantLight];
        self.textInsets = UIEdgeInsetsMake(0, 16, 0, 8);
...
{
    return [placeholder attributedStringWithAttributes:@{ NSForegroundColorAttributeName : [UIColor.blackColor colorWithAlphaComponent:0.4],
...
- (void)setEnabled:(BOOL)enabled
{
    ...
    if (enabled) {
        ...
        self.textColor = [UIColor.blackColor colorWithAlphaComponent:0.4];
    }
}
