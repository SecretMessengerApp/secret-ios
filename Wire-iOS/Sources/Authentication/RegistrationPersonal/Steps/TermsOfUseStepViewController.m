...
- (void)createTitleLabel
{
    ...
    self.titleLabel.textColor = [UIColor wr_colorFromColorScheme:ColorSchemeColorTextForeground variant:ColorSchemeVariantLight];
...
- (void)createTermsOfUseText
{
    ...
    [[NSMutableAttributedString alloc] initWithString:termsOfUse
                                           attributes:@{ NSFontAttributeName : UIFont.largeLightFont,
                                                         NSForegroundColorAttributeName: [UIColor wr_colorFromColorScheme:ColorSchemeColorTextForeground variant:ColorSchemeVariantLight] }];
...
- (void)createAgreeButton
{
    ...
    self.agreeButton.layer.cornerRadius = 20;
    self.agreeButton.layer.masksToBounds = true;
    [self.agreeButton setBackgroundImageColor:UIColor.defaultBlue forState:UIControlStateNormal];
