...
class PhoneNumberInputView: UIView, UITextFieldDelegate, TextFieldValidationDelegate, TextContainer {
    ...
    private func configureSubviews() {
        ...
        countryCodeInputView.setBackgroundImageColor(.dynamic(scheme: .title), for: .normal)
        countryCodeInputView.setTitleColor(UIColor.dynamic(scheme: .title), for: .normal)
    ...
    var textColor: UIColor = UIColor.dynamic(scheme: .title) {
        didSet {
