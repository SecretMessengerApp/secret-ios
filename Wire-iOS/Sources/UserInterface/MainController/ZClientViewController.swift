...
final class ZClientViewController: UIViewController {
    ...
    required init(account: Account, selfUser: SelfUserType) {
        
        mainTabBarController = MainTabBarController()
        conversationListViewController = mainTabBarController!.conversationListViewController
...
//        createBackgroundViewController()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        ZMUserSession.shared()?.uiFinished()
    }
    ...
    ///   - scrollToApp: scroll to specify conversation app
    func load(_ conversation: ZMConversation,
              scrollTo message: ZMConversationMessage?,
              focusOnView focus: Bool,
              animated: Bool,
              completion: Completion? = nil,
              scrollToApp: String? = nil) {
        if conversation === currentConversation,
           conversationRootController != nil {
            ...
            conversationRootController = ConversationRootViewController(conversation: conversation, message: message, clientViewController: self, scrollToApp: scrollToApp)
        }
    ...
    func loadIncomingContactRequestsAndFocus(onView focus: Bool, animated: Bool) {
        currentConversation = nil
        let inbox = NewConnectRequestsViewController()
    ...
    private func updateSplitViewTopConstraint() {
        ...
        let isRegularContainer = false // traitCollection.horizontalSizeClass == .regular
