...
final class ConversationImagesViewController: TintColorCorrectedViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let navigationBar = navigationController?.navigationBar {
            ...
            navigationBar.barTintColor = UIColor.dynamic(scheme: .barBackground)
        }
    ...
    private func createControlsBarButtons() -> [IconButton] {
        ...
        buttons.forEach {
            ...
            $0.setIconColor(.dynamic(scheme: .iconNormal), for: .normal)
        }
    ...
    private func createControlsBar() {
        ...
        self.buttonsBar.expandRowButton.setIconColor(UIColor.dynamic(scheme: .title), for: .normal)
        self.buttonsBar.backgroundColor = UIColor.dynamic(scheme: .barBackground)
