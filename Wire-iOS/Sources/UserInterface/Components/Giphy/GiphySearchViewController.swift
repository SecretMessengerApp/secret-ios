...
final class GiphySearchViewController: VerticalColumnCollectionViewController {
    ...
    private func applyStyle() {
        ...
        noResultsLabel.textColor = .dynamic(scheme: .title)
    ...
    func wrapInsideNavigationController() -> UINavigationController {
        ...
        navigationController.navigationBar.tintColor = .dynamic(scheme: .title)
        ...
        navigationController.navigationBar.barTintColor = .dynamic(scheme: .background)
