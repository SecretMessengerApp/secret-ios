...
extension Notification.Name {
 ...
 final class MarkdownTextView: NextResponderTextView {
    ...
    func updateTextColor() {
        ...
        self.style.baseFontColor = .dynamic(scheme: .title)
    }
