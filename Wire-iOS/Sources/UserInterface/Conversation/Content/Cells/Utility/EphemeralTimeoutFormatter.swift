...
class EphemeralTimeoutFormatter {
    ...
    private func timeString(from interval: TimeInterval) -> String? {
        ...
        if date < calendar.date(byAdding: .minute, value: 1, to: now) {
            secondsFormatter.calendar = calendar
            ...
            dayFormatter.dayFormatter.calendar = calendar
            dayFormatter.hourFormatter.calendar = calendar
