...
protocol ConversationMessageCellDelegate: MessageActionResponder, ConversationMessageCellLegacyDelegate {
...
enum MessageBackImage: String {
    case mine = "message_back_self"
    case mineWithTail = "message_back_self_tail"
    case other = "message_back_other"
    case otherWithTail = "message_back_other_tail"
}
