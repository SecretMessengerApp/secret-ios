...
class ConversationMessageCellTableViewAdapter<C: ConversationMessageCellDescription>: UITableViewCell, SelectableView, HighlightableView, ConversationMessageCellMenuPresenter {
    ...
    var leftMargin: Float = 56 {
        didSet {
            leading.constant = CGFloat(leftMargin)
        }
    }
    var rightMargin: Float = 0 {
        didSet {
            trailing.constant = CGFloat(-rightMargin)
        }
    }
    ...
    func configureConstraints(fullWidth: Bool) {
        ...
        leading.constant = CGFloat(fullWidth ? 0 : self.leftMargin)
        trailing.constant = CGFloat(fullWidth ? 0 : -self.rightMargin)
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        if self.cellView.isSelected != selected {
    ...
    func showMenu() {
        ...
        menu.menuItems = cellDescription?.actionController?.allMessageActions
