...
class ProfileClientViewController: UIViewController {
    ...
    private func setupDescriptionTextView() {
        ...
        descriptionTextView.textColor = .dynamic(scheme: .title)
    ...
    private func setupSeparatorLineView() {
        separatorLineView.backgroundColor = .dynamic(scheme: .separator)
    ...
    private func setupTypeLabel() {
        ...
        typeLabel.textColor = UIColor.dynamic(scheme: .title)
        self.contentView.addSubview(typeLabel)
    }
    
    private func setupIDLabel() {
        IDLabel.numberOfLines = 1
        IDLabel.textColor = UIColor.dynamic(scheme: .title)
    ...
    private func setupFullIDLabel() {
        ...
        fullIDLabel.textColor = UIColor.dynamic(scheme: .title)
    ...
    private func setupVerifiedToggleLabel() {
        ...
        verifiedToggleLabel.textColor = UIColor.dynamic(scheme: .title)
