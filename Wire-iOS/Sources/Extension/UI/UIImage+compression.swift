...
extension UIImage {
    ...
    func compressionImage(_ maxSizeKB: CGFloat = 250, size: CGSize? = nil) -> UIImage? {
        guard let data = self.compressionImageData(maxSizeKB, size: size) else { return nil }
        return UIImage(data: data)
    }
    

    func compressionImageData(_ maxSizeKB: CGFloat = 250, size: CGSize? = nil) -> Data? {

        guard let newImage = self.resizeImageSize(with: size) else { return nil }
    ...
    func resizeImageSize(with size: CGSize?) -> UIImage? {
