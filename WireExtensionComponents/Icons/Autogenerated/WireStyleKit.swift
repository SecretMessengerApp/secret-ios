...
//  Wire for iOS
//
//  Created by Wire Design Team on 25.10.18.
...
public class WireStyleKit : NSObject {
    ...
    @objc dynamic public class func drawIcon_0x100_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x102_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x104_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x105_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Path Drawing
        let pathPath = UIBezierPath()
        pathPath.move(to: CGPoint(x: 64, y: 32))
        pathPath.addCurve(to: CGPoint(x: 32, y: 0), controlPoint1: CGPoint(x: 64, y: 14.33), controlPoint2: CGPoint(x: 49.67, y: 0))
        pathPath.addCurve(to: CGPoint(x: 0, y: 32), controlPoint1: CGPoint(x: 14.33, y: 0), controlPoint2: CGPoint(x: 0, y: 14.33))
        pathPath.addCurve(to: CGPoint(x: 32, y: 64), controlPoint1: CGPoint(x: 0, y: 49.67), controlPoint2: CGPoint(x: 14.33, y: 64))
        pathPath.addCurve(to: CGPoint(x: 64, y: 32), controlPoint1: CGPoint(x: 49.67, y: 64), controlPoint2: CGPoint(x: 64, y: 49.67))
        pathPath.close()
        pathPath.move(to: CGPoint(x: 4, y: 32))
        pathPath.addCurve(to: CGPoint(x: 32, y: 4), controlPoint1: CGPoint(x: 4, y: 16.54), controlPoint2: CGPoint(x: 16.54, y: 4))
        pathPath.addCurve(to: CGPoint(x: 60, y: 32), controlPoint1: CGPoint(x: 47.46, y: 4), controlPoint2: CGPoint(x: 60, y: 16.54))
        pathPath.addCurve(to: CGPoint(x: 32, y: 60), controlPoint1: CGPoint(x: 60, y: 47.46), controlPoint2: CGPoint(x: 47.46, y: 60))
        pathPath.addCurve(to: CGPoint(x: 4, y: 32), controlPoint1: CGPoint(x: 16.54, y: 60), controlPoint2: CGPoint(x: 4, y: 47.46))
        pathPath.close()
        pathPath.move(to: CGPoint(x: 20, y: 30))
        pathPath.addCurve(to: CGPoint(x: 18, y: 32), controlPoint1: CGPoint(x: 18.9, y: 30), controlPoint2: CGPoint(x: 18, y: 30.9))
        pathPath.addCurve(to: CGPoint(x: 20, y: 34), controlPoint1: CGPoint(x: 18, y: 33.1), controlPoint2: CGPoint(x: 18.9, y: 34))
        pathPath.addLine(to: CGPoint(x: 44, y: 34))
        pathPath.addCurve(to: CGPoint(x: 46, y: 32), controlPoint1: CGPoint(x: 45.1, y: 34), controlPoint2: CGPoint(x: 46, y: 33.1))
        pathPath.addCurve(to: CGPoint(x: 44, y: 30), controlPoint1: CGPoint(x: 46, y: 30.9), controlPoint2: CGPoint(x: 45.1, y: 30))
        pathPath.addLine(to: CGPoint(x: 20, y: 30))
        pathPath.close()
    ...
    @objc dynamic public class func drawIcon_0x120_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x125_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x137_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x143_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x144_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x145_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x150_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x158_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x162_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x177_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x193_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Flash Drawing
        let flashPath = UIBezierPath()
        flashPath.move(to: CGPoint(x: 28, y: 36))
        flashPath.addLine(to: CGPoint(x: 12, y: 36))
        flashPath.addLine(to: CGPoint(x: 36, y: 0))
        flashPath.addLine(to: CGPoint(x: 36, y: 28))
        flashPath.addLine(to: CGPoint(x: 52, y: 28))
        flashPath.addLine(to: CGPoint(x: 28, y: 64))
        flashPath.addLine(to: CGPoint(x: 28, y: 36))
        flashPath.close()
        flashPath.usesEvenOddFillRule = true
        color.setFill()
        flashPath.fill()
    }

    @objc dynamic public class func drawIcon_0x194_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Flash-off Drawing
        let flashoffPath = UIBezierPath()
        flashoffPath.move(to: CGPoint(x: 35.93, y: 24.37))
        flashoffPath.addLine(to: CGPoint(x: 35.93, y: 0))
        flashoffPath.addLine(to: CGPoint(x: 11.68, y: 36))
        flashoffPath.addLine(to: CGPoint(x: 18.95, y: 36))
        flashoffPath.addLine(to: CGPoint(x: 3.32, y: 46.71))
        flashoffPath.addLine(to: CGPoint(x: 0, y: 48.99))
        flashoffPath.addLine(to: CGPoint(x: 4.6, y: 55.57))
        flashoffPath.addLine(to: CGPoint(x: 7.92, y: 53.29))
        flashoffPath.addLine(to: CGPoint(x: 60.46, y: 17.29))
        flashoffPath.addLine(to: CGPoint(x: 63.78, y: 15.01))
        flashoffPath.addLine(to: CGPoint(x: 59.18, y: 8.43))
        flashoffPath.addLine(to: CGPoint(x: 55.86, y: 10.71))
        flashoffPath.addLine(to: CGPoint(x: 35.93, y: 24.37))
        flashoffPath.addLine(to: CGPoint(x: 35.93, y: 24.37))
        flashoffPath.close()
        flashoffPath.move(to: CGPoint(x: 48.32, y: 33.61))
        flashoffPath.addLine(to: CGPoint(x: 27.85, y: 64))
        flashoffPath.addLine(to: CGPoint(x: 27.85, y: 47.63))
        flashoffPath.addLine(to: CGPoint(x: 48.32, y: 33.61))
        flashoffPath.addLine(to: CGPoint(x: 48.32, y: 33.61))
        flashoffPath.close()
    ...
    @objc dynamic public class func drawIcon_0x195_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Flash-auto Drawing
        let flashautoPath = UIBezierPath()
        flashautoPath.move(to: CGPoint(x: 28, y: 36))
        flashautoPath.addLine(to: CGPoint(x: 12, y: 36))
        flashautoPath.addLine(to: CGPoint(x: 36, y: 0))
        flashautoPath.addLine(to: CGPoint(x: 36, y: 28))
        flashautoPath.addLine(to: CGPoint(x: 52, y: 28))
        flashautoPath.addLine(to: CGPoint(x: 28, y: 64))
        flashautoPath.addLine(to: CGPoint(x: 28, y: 36))
        flashautoPath.close()
        flashautoPath.move(to: CGPoint(x: 52, y: 44))
        flashautoPath.addLine(to: CGPoint(x: 64, y: 64))
        flashautoPath.addLine(to: CGPoint(x: 40, y: 64))
        flashautoPath.addLine(to: CGPoint(x: 52, y: 44))
        flashautoPath.close()
        flashautoPath.usesEvenOddFillRule = true
        color.setFill()
        flashautoPath.fill()
    }

    @objc dynamic public class func drawIcon_0x197_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x205_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Path Drawing
        let pathPath = UIBezierPath()
        pathPath.move(to: CGPoint(x: 29, y: 62))
        pathPath.addCurve(to: CGPoint(x: 27, y: 60), controlPoint1: CGPoint(x: 29, y: 60.9), controlPoint2: CGPoint(x: 28.1, y: 60))
        pathPath.addLine(to: CGPoint(x: 4, y: 60))
        pathPath.addLine(to: CGPoint(x: 4, y: 4))
        pathPath.addLine(to: CGPoint(x: 27, y: 4))
        pathPath.addCurve(to: CGPoint(x: 29, y: 2), controlPoint1: CGPoint(x: 28.1, y: 4), controlPoint2: CGPoint(x: 29, y: 3.1))
        pathPath.addCurve(to: CGPoint(x: 27, y: 0), controlPoint1: CGPoint(x: 29, y: 0.89), controlPoint2: CGPoint(x: 28.1, y: 0))
        pathPath.addLine(to: CGPoint(x: 2, y: 0))
        pathPath.addCurve(to: CGPoint(x: 0, y: 2), controlPoint1: CGPoint(x: 0.9, y: 0), controlPoint2: CGPoint(x: 0, y: 0.89))
        pathPath.addLine(to: CGPoint(x: 0, y: 62))
        pathPath.addCurve(to: CGPoint(x: 2, y: 64), controlPoint1: CGPoint(x: 0, y: 63.1), controlPoint2: CGPoint(x: 0.9, y: 64))
        pathPath.addLine(to: CGPoint(x: 27, y: 64))
        pathPath.addCurve(to: CGPoint(x: 29, y: 62), controlPoint1: CGPoint(x: 28.1, y: 64), controlPoint2: CGPoint(x: 29, y: 63.1))
        pathPath.close()
        pathPath.move(to: CGPoint(x: 45, y: 17))
        pathPath.addCurve(to: CGPoint(x: 45.59, y: 18.41), controlPoint1: CGPoint(x: 45, y: 17.51), controlPoint2: CGPoint(x: 45.2, y: 18.02))
        pathPath.addLine(to: CGPoint(x: 57.17, y: 30))
        pathPath.addLine(to: CGPoint(x: 17, y: 30))
        pathPath.addCurve(to: CGPoint(x: 15, y: 32), controlPoint1: CGPoint(x: 15.9, y: 30), controlPoint2: CGPoint(x: 15, y: 30.9))
        pathPath.addCurve(to: CGPoint(x: 17, y: 34), controlPoint1: CGPoint(x: 15, y: 33.1), controlPoint2: CGPoint(x: 15.9, y: 34))
        pathPath.addLine(to: CGPoint(x: 57.17, y: 34))
        pathPath.addLine(to: CGPoint(x: 45.59, y: 45.59))
        pathPath.addCurve(to: CGPoint(x: 45, y: 47), controlPoint1: CGPoint(x: 45.2, y: 45.98), controlPoint2: CGPoint(x: 45, y: 46.49))
        pathPath.addCurve(to: CGPoint(x: 45.59, y: 48.41), controlPoint1: CGPoint(x: 45, y: 47.51), controlPoint2: CGPoint(x: 45.2, y: 48.02))
        pathPath.addCurve(to: CGPoint(x: 48.41, y: 48.41), controlPoint1: CGPoint(x: 46.37, y: 49.2), controlPoint2: CGPoint(x: 47.63, y: 49.2))
        pathPath.addLine(to: CGPoint(x: 63.41, y: 33.41))
        pathPath.addCurve(to: CGPoint(x: 63.42, y: 33.41), controlPoint1: CGPoint(x: 63.42, y: 33.41), controlPoint2: CGPoint(x: 63.42, y: 33.41))
        pathPath.addCurve(to: CGPoint(x: 63.66, y: 33.11), controlPoint1: CGPoint(x: 63.51, y: 33.32), controlPoint2: CGPoint(x: 63.59, y: 33.22))
        pathPath.addCurve(to: CGPoint(x: 63.75, y: 32.96), controlPoint1: CGPoint(x: 63.7, y: 33.06), controlPoint2: CGPoint(x: 63.72, y: 33.01))
        pathPath.addCurve(to: CGPoint(x: 63.85, y: 32.76), controlPoint1: CGPoint(x: 63.78, y: 32.89), controlPoint2: CGPoint(x: 63.82, y: 32.83))
        pathPath.addCurve(to: CGPoint(x: 63.91, y: 32.57), controlPoint1: CGPoint(x: 63.87, y: 32.7), controlPoint2: CGPoint(x: 63.89, y: 32.63))
        pathPath.addCurve(to: CGPoint(x: 63.96, y: 32.39), controlPoint1: CGPoint(x: 63.93, y: 32.51), controlPoint2: CGPoint(x: 63.95, y: 32.45))
        pathPath.addCurve(to: CGPoint(x: 64, y: 32.02), controlPoint1: CGPoint(x: 63.98, y: 32.27), controlPoint2: CGPoint(x: 64, y: 32.15))
        pathPath.addCurve(to: CGPoint(x: 64, y: 32), controlPoint1: CGPoint(x: 64, y: 32.02), controlPoint2: CGPoint(x: 64, y: 32.01))
        pathPath.addCurve(to: CGPoint(x: 64, y: 31.98), controlPoint1: CGPoint(x: 64, y: 31.99), controlPoint2: CGPoint(x: 64, y: 31.98))
        pathPath.addCurve(to: CGPoint(x: 63.96, y: 31.61), controlPoint1: CGPoint(x: 64, y: 31.85), controlPoint2: CGPoint(x: 63.98, y: 31.73))
        pathPath.addCurve(to: CGPoint(x: 63.91, y: 31.43), controlPoint1: CGPoint(x: 63.95, y: 31.55), controlPoint2: CGPoint(x: 63.93, y: 31.49))
        pathPath.addCurve(to: CGPoint(x: 63.85, y: 31.24), controlPoint1: CGPoint(x: 63.89, y: 31.37), controlPoint2: CGPoint(x: 63.87, y: 31.3))
        pathPath.addCurve(to: CGPoint(x: 63.75, y: 31.04), controlPoint1: CGPoint(x: 63.82, y: 31.17), controlPoint2: CGPoint(x: 63.78, y: 31.11))
        pathPath.addCurve(to: CGPoint(x: 63.66, y: 30.89), controlPoint1: CGPoint(x: 63.72, y: 30.99), controlPoint2: CGPoint(x: 63.7, y: 30.94))
        pathPath.addCurve(to: CGPoint(x: 63.42, y: 30.6), controlPoint1: CGPoint(x: 63.59, y: 30.78), controlPoint2: CGPoint(x: 63.51, y: 30.69))
        pathPath.addCurve(to: CGPoint(x: 63.41, y: 30.59), controlPoint1: CGPoint(x: 63.42, y: 30.59), controlPoint2: CGPoint(x: 63.42, y: 30.59))
        pathPath.addLine(to: CGPoint(x: 48.41, y: 15.59))
        pathPath.addCurve(to: CGPoint(x: 45.59, y: 15.59), controlPoint1: CGPoint(x: 47.63, y: 14.8), controlPoint2: CGPoint(x: 46.37, y: 14.8))
        pathPath.addCurve(to: CGPoint(x: 45, y: 17), controlPoint1: CGPoint(x: 45.2, y: 15.98), controlPoint2: CGPoint(x: 45, y: 16.49))
        pathPath.close()
        pathPath.usesEvenOddFillRule = true
        color.setFill()
        pathPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x212_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Archive Drawing
        let archivePath = UIBezierPath()
        archivePath.move(to: CGPoint(x: 0, y: 20))
        archivePath.addLine(to: CGPoint(x: 0, y: 36))
        archivePath.addLine(to: CGPoint(x: 64, y: 36))
        archivePath.addLine(to: CGPoint(x: 64, y: 20))
        archivePath.addLine(to: CGPoint(x: 40, y: 20))
        archivePath.addLine(to: CGPoint(x: 40, y: 28))
        archivePath.addLine(to: CGPoint(x: 24, y: 28))
        archivePath.addLine(to: CGPoint(x: 24, y: 20))
        archivePath.addLine(to: CGPoint(x: 0, y: 20))
        archivePath.close()
        archivePath.move(to: CGPoint(x: 0, y: 44))
        archivePath.addLine(to: CGPoint(x: 0, y: 60))
        archivePath.addLine(to: CGPoint(x: 64, y: 60))
        archivePath.addLine(to: CGPoint(x: 64, y: 44))
        archivePath.addLine(to: CGPoint(x: 40, y: 44))
        archivePath.addLine(to: CGPoint(x: 40, y: 52))
        archivePath.addLine(to: CGPoint(x: 24, y: 52))
        archivePath.addLine(to: CGPoint(x: 24, y: 44))
        archivePath.addLine(to: CGPoint(x: 0, y: 44))
        archivePath.close()
        archivePath.move(to: CGPoint(x: 64, y: 4))
        archivePath.addLine(to: CGPoint(x: 64, y: 12))
        archivePath.addLine(to: CGPoint(x: 0, y: 12))
        archivePath.addLine(to: CGPoint(x: 0, y: 4))
        archivePath.addLine(to: CGPoint(x: 64, y: 4))
        archivePath.close()
        archivePath.usesEvenOddFillRule = true
        color.setFill()
        archivePath.fill()
    }

    @objc dynamic public class func drawIcon_0x198_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x160_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x101_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x215_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x216_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x172_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x217_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Added Drawing
        let addedPath = UIBezierPath()
        addedPath.move(to: CGPoint(x: 0, y: 32))
        addedPath.addCurve(to: CGPoint(x: 32, y: 0), controlPoint1: CGPoint(x: 0, y: 14.33), controlPoint2: CGPoint(x: 14.33, y: 0))
        addedPath.addCurve(to: CGPoint(x: 64, y: 32), controlPoint1: CGPoint(x: 49.67, y: 0), controlPoint2: CGPoint(x: 64, y: 14.33))
        addedPath.addCurve(to: CGPoint(x: 32, y: 64), controlPoint1: CGPoint(x: 64, y: 49.67), controlPoint2: CGPoint(x: 49.67, y: 64))
        addedPath.addCurve(to: CGPoint(x: 0, y: 32), controlPoint1: CGPoint(x: 14.33, y: 64), controlPoint2: CGPoint(x: 0, y: 49.67))
        addedPath.close()
        addedPath.move(to: CGPoint(x: 26.63, y: 51.43))
        addedPath.addLine(to: CGPoint(x: 54.88, y: 23.46))
        addedPath.addLine(to: CGPoint(x: 49.22, y: 17.8))
        addedPath.addLine(to: CGPoint(x: 26.63, y: 40.12))
        addedPath.addLine(to: CGPoint(x: 14.58, y: 28.31))
        addedPath.addLine(to: CGPoint(x: 8.92, y: 33.97))
        addedPath.addLine(to: CGPoint(x: 26.63, y: 51.43))
        addedPath.close()
        addedPath.usesEvenOddFillRule = true
        color.setFill()
        addedPath.fill()
    }

    @objc dynamic public class func drawIcon_0x117_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x179_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x219_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x116_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x126_24pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Path-3 Drawing
        let path3Path = UIBezierPath()
        path3Path.move(to: CGPoint(x: 38.85, y: 38.85))
        path3Path.addCurve(to: CGPoint(x: 9.15, y: 38.85), controlPoint1: CGPoint(x: 30.65, y: 47.05), controlPoint2: CGPoint(x: 17.35, y: 47.05))
        path3Path.addCurve(to: CGPoint(x: 9.15, y: 9.15), controlPoint1: CGPoint(x: 0.95, y: 30.65), controlPoint2: CGPoint(x: 0.95, y: 17.35))
        path3Path.addCurve(to: CGPoint(x: 33.05, y: 5.05), controlPoint1: CGPoint(x: 15.49, y: 2.81), controlPoint2: CGPoint(x: 25.09, y: 1.24))
        path3Path.addCurve(to: CGPoint(x: 35.05, y: 4.34), controlPoint1: CGPoint(x: 33.8, y: 5.4), controlPoint2: CGPoint(x: 34.69, y: 5.09))
        path3Path.addCurve(to: CGPoint(x: 34.34, y: 2.34), controlPoint1: CGPoint(x: 35.41, y: 3.59), controlPoint2: CGPoint(x: 35.09, y: 2.7))
        path3Path.addCurve(to: CGPoint(x: 7.03, y: 7.03), controlPoint1: CGPoint(x: 25.24, y: -2.01), controlPoint2: CGPoint(x: 14.28, y: -0.22))
        path3Path.addCurve(to: CGPoint(x: 7.03, y: 40.97), controlPoint1: CGPoint(x: -2.34, y: 16.4), controlPoint2: CGPoint(x: -2.34, y: 31.6))
        path3Path.addCurve(to: CGPoint(x: 40.97, y: 40.97), controlPoint1: CGPoint(x: 16.4, y: 50.34), controlPoint2: CGPoint(x: 31.6, y: 50.34))
        path3Path.addCurve(to: CGPoint(x: 45.66, y: 13.66), controlPoint1: CGPoint(x: 48.21, y: 33.72), controlPoint2: CGPoint(x: 50.01, y: 22.77))
        path3Path.addCurve(to: CGPoint(x: 43.66, y: 12.96), controlPoint1: CGPoint(x: 45.31, y: 12.92), controlPoint2: CGPoint(x: 44.41, y: 12.6))
        path3Path.addCurve(to: CGPoint(x: 42.96, y: 14.96), controlPoint1: CGPoint(x: 42.92, y: 13.31), controlPoint2: CGPoint(x: 42.6, y: 14.21))
        path3Path.addCurve(to: CGPoint(x: 38.85, y: 38.85), controlPoint1: CGPoint(x: 46.76, y: 22.92), controlPoint2: CGPoint(x: 45.19, y: 32.51))
        path3Path.close()
    ...
    @objc dynamic public class func drawIcon_0x128_8pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x126_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x165_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x187_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Card Drawing
        let cardPath = UIBezierPath()
        cardPath.move(to: CGPoint(x: 0, y: 16.02))
        cardPath.addCurve(to: CGPoint(x: 7.98, y: 8), controlPoint1: CGPoint(x: 0, y: 11.59), controlPoint2: CGPoint(x: 3.58, y: 8))
        cardPath.addLine(to: CGPoint(x: 56.02, y: 8))
        cardPath.addCurve(to: CGPoint(x: 64, y: 16.02), controlPoint1: CGPoint(x: 60.43, y: 8), controlPoint2: CGPoint(x: 64, y: 11.59))
        cardPath.addLine(to: CGPoint(x: 64, y: 55.98))
        cardPath.addCurve(to: CGPoint(x: 56.02, y: 64), controlPoint1: CGPoint(x: 64, y: 60.41), controlPoint2: CGPoint(x: 60.42, y: 64))
        cardPath.addLine(to: CGPoint(x: 7.98, y: 64))
        cardPath.addCurve(to: CGPoint(x: 0, y: 55.98), controlPoint1: CGPoint(x: 3.57, y: 64), controlPoint2: CGPoint(x: 0, y: 60.41))
        cardPath.addLine(to: CGPoint(x: 0, y: 16.02))
        cardPath.addLine(to: CGPoint(x: 0, y: 16.02))
        cardPath.addLine(to: CGPoint(x: 0, y: 16.02))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 24, y: 12))
        cardPath.addLine(to: CGPoint(x: 40, y: 12))
        cardPath.addLine(to: CGPoint(x: 40, y: 16))
        cardPath.addLine(to: CGPoint(x: 24, y: 16))
        cardPath.addLine(to: CGPoint(x: 24, y: 12))
        cardPath.addLine(to: CGPoint(x: 24, y: 12))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 8, y: 24))
        cardPath.addLine(to: CGPoint(x: 28, y: 24))
        cardPath.addLine(to: CGPoint(x: 28, y: 44))
        cardPath.addLine(to: CGPoint(x: 8, y: 44))
        cardPath.addLine(to: CGPoint(x: 8, y: 24))
        cardPath.addLine(to: CGPoint(x: 8, y: 24))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 56, y: 24))
        cardPath.addLine(to: CGPoint(x: 36, y: 24))
        cardPath.addLine(to: CGPoint(x: 36, y: 32))
        cardPath.addLine(to: CGPoint(x: 56, y: 32))
        cardPath.addLine(to: CGPoint(x: 56, y: 24))
        cardPath.addLine(to: CGPoint(x: 56, y: 24))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 56, y: 36))
        cardPath.addLine(to: CGPoint(x: 36, y: 36))
        cardPath.addLine(to: CGPoint(x: 36, y: 44))
        cardPath.addLine(to: CGPoint(x: 56, y: 44))
        cardPath.addLine(to: CGPoint(x: 56, y: 36))
        cardPath.addLine(to: CGPoint(x: 56, y: 36))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 56, y: 48))
        cardPath.addLine(to: CGPoint(x: 8, y: 48))
        cardPath.addLine(to: CGPoint(x: 8, y: 56))
        cardPath.addLine(to: CGPoint(x: 56, y: 56))
        cardPath.addLine(to: CGPoint(x: 56, y: 48))
        cardPath.close()
        cardPath.move(to: CGPoint(x: 24, y: 0))
        cardPath.addLine(to: CGPoint(x: 40, y: 0))
        cardPath.addLine(to: CGPoint(x: 40, y: 8))
        cardPath.addLine(to: CGPoint(x: 24, y: 8))
        cardPath.addLine(to: CGPoint(x: 24, y: 0))
        cardPath.close()
        cardPath.usesEvenOddFillRule = true
        color.setFill()
        cardPath.fill()
    }

    @objc dynamic public class func drawIcon_0x163_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x221_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Theme Drawing
        let themePath = UIBezierPath()
        themePath.move(to: CGPoint(x: 32, y: 48))
        themePath.addCurve(to: CGPoint(x: 48, y: 32), controlPoint1: CGPoint(x: 40.84, y: 48), controlPoint2: CGPoint(x: 48, y: 40.84))
        themePath.addCurve(to: CGPoint(x: 32, y: 16), controlPoint1: CGPoint(x: 48, y: 23.16), controlPoint2: CGPoint(x: 40.84, y: 16))
        themePath.addCurve(to: CGPoint(x: 16, y: 32), controlPoint1: CGPoint(x: 23.16, y: 16), controlPoint2: CGPoint(x: 16, y: 23.16))
        themePath.addCurve(to: CGPoint(x: 32, y: 48), controlPoint1: CGPoint(x: 16, y: 40.84), controlPoint2: CGPoint(x: 23.16, y: 48))
        themePath.addLine(to: CGPoint(x: 32, y: 48))
        themePath.close()
        themePath.move(to: CGPoint(x: 28, y: 4))
        themePath.addCurve(to: CGPoint(x: 32, y: 0), controlPoint1: CGPoint(x: 28, y: 1.79), controlPoint2: CGPoint(x: 29.78, y: 0))
        themePath.addCurve(to: CGPoint(x: 36, y: 4), controlPoint1: CGPoint(x: 34.21, y: 0), controlPoint2: CGPoint(x: 36, y: 1.77))
        themePath.addLine(to: CGPoint(x: 36, y: 8))
        themePath.addCurve(to: CGPoint(x: 32, y: 12), controlPoint1: CGPoint(x: 36, y: 10.21), controlPoint2: CGPoint(x: 34.22, y: 12))
        themePath.addCurve(to: CGPoint(x: 28, y: 8), controlPoint1: CGPoint(x: 29.79, y: 12), controlPoint2: CGPoint(x: 28, y: 10.23))
        themePath.addLine(to: CGPoint(x: 28, y: 4))
        themePath.addLine(to: CGPoint(x: 28, y: 4))
        themePath.close()
        themePath.move(to: CGPoint(x: 28, y: 56))
        themePath.addCurve(to: CGPoint(x: 32, y: 52), controlPoint1: CGPoint(x: 28, y: 53.79), controlPoint2: CGPoint(x: 29.78, y: 52))
        themePath.addCurve(to: CGPoint(x: 36, y: 56), controlPoint1: CGPoint(x: 34.21, y: 52), controlPoint2: CGPoint(x: 36, y: 53.77))
        themePath.addLine(to: CGPoint(x: 36, y: 60))
        themePath.addCurve(to: CGPoint(x: 32, y: 64), controlPoint1: CGPoint(x: 36, y: 62.21), controlPoint2: CGPoint(x: 34.22, y: 64))
        themePath.addCurve(to: CGPoint(x: 28, y: 60), controlPoint1: CGPoint(x: 29.79, y: 64), controlPoint2: CGPoint(x: 28, y: 62.23))
        themePath.addLine(to: CGPoint(x: 28, y: 56))
        themePath.addLine(to: CGPoint(x: 28, y: 56))
        themePath.close()
        themePath.move(to: CGPoint(x: 4, y: 36))
        themePath.addCurve(to: CGPoint(x: 0, y: 32), controlPoint1: CGPoint(x: 1.79, y: 36), controlPoint2: CGPoint(x: 0, y: 34.22))
        themePath.addCurve(to: CGPoint(x: 4, y: 28), controlPoint1: CGPoint(x: 0, y: 29.79), controlPoint2: CGPoint(x: 1.77, y: 28))
        themePath.addLine(to: CGPoint(x: 8, y: 28))
        themePath.addCurve(to: CGPoint(x: 12, y: 32), controlPoint1: CGPoint(x: 10.21, y: 28), controlPoint2: CGPoint(x: 12, y: 29.78))
        themePath.addCurve(to: CGPoint(x: 8, y: 36), controlPoint1: CGPoint(x: 12, y: 34.21), controlPoint2: CGPoint(x: 10.23, y: 36))
        themePath.addLine(to: CGPoint(x: 4, y: 36))
        themePath.addLine(to: CGPoint(x: 4, y: 36))
        themePath.close()
        themePath.move(to: CGPoint(x: 56, y: 36))
        themePath.addCurve(to: CGPoint(x: 52, y: 32), controlPoint1: CGPoint(x: 53.79, y: 36), controlPoint2: CGPoint(x: 52, y: 34.22))
        themePath.addCurve(to: CGPoint(x: 56, y: 28), controlPoint1: CGPoint(x: 52, y: 29.79), controlPoint2: CGPoint(x: 53.77, y: 28))
        themePath.addLine(to: CGPoint(x: 60, y: 28))
        themePath.addCurve(to: CGPoint(x: 64, y: 32), controlPoint1: CGPoint(x: 62.21, y: 28), controlPoint2: CGPoint(x: 64, y: 29.78))
        themePath.addCurve(to: CGPoint(x: 60, y: 36), controlPoint1: CGPoint(x: 64, y: 34.21), controlPoint2: CGPoint(x: 62.23, y: 36))
        themePath.addLine(to: CGPoint(x: 56, y: 36))
        themePath.addLine(to: CGPoint(x: 56, y: 36))
        themePath.close()
        themePath.move(to: CGPoint(x: 9.37, y: 15.03))
        themePath.addCurve(to: CGPoint(x: 9.37, y: 9.37), controlPoint1: CGPoint(x: 7.81, y: 13.47), controlPoint2: CGPoint(x: 7.8, y: 10.95))
        themePath.addCurve(to: CGPoint(x: 15.03, y: 9.37), controlPoint1: CGPoint(x: 10.93, y: 7.81), controlPoint2: CGPoint(x: 13.45, y: 7.8))
        themePath.addLine(to: CGPoint(x: 17.86, y: 12.2))
        themePath.addCurve(to: CGPoint(x: 17.86, y: 17.86), controlPoint1: CGPoint(x: 19.42, y: 13.76), controlPoint2: CGPoint(x: 19.43, y: 16.28))
        themePath.addCurve(to: CGPoint(x: 12.2, y: 17.86), controlPoint1: CGPoint(x: 16.3, y: 19.42), controlPoint2: CGPoint(x: 13.78, y: 19.43))
        themePath.addLine(to: CGPoint(x: 9.37, y: 15.03))
        themePath.addLine(to: CGPoint(x: 9.37, y: 15.03))
        themePath.close()
        themePath.move(to: CGPoint(x: 46.14, y: 51.8))
        themePath.addCurve(to: CGPoint(x: 46.14, y: 46.14), controlPoint1: CGPoint(x: 44.58, y: 50.24), controlPoint2: CGPoint(x: 44.57, y: 47.72))
        themePath.addCurve(to: CGPoint(x: 51.8, y: 46.14), controlPoint1: CGPoint(x: 47.7, y: 44.58), controlPoint2: CGPoint(x: 50.22, y: 44.57))
        themePath.addLine(to: CGPoint(x: 54.63, y: 48.97))
        themePath.addCurve(to: CGPoint(x: 54.63, y: 54.63), controlPoint1: CGPoint(x: 56.19, y: 50.53), controlPoint2: CGPoint(x: 56.2, y: 53.05))
        themePath.addCurve(to: CGPoint(x: 48.97, y: 54.63), controlPoint1: CGPoint(x: 53.07, y: 56.19), controlPoint2: CGPoint(x: 50.55, y: 56.2))
        themePath.addLine(to: CGPoint(x: 46.14, y: 51.8))
        themePath.addLine(to: CGPoint(x: 46.14, y: 51.8))
        themePath.close()
        themePath.move(to: CGPoint(x: 15.03, y: 54.63))
        themePath.addCurve(to: CGPoint(x: 9.37, y: 54.63), controlPoint1: CGPoint(x: 13.47, y: 56.19), controlPoint2: CGPoint(x: 10.95, y: 56.2))
        themePath.addCurve(to: CGPoint(x: 9.37, y: 48.97), controlPoint1: CGPoint(x: 7.81, y: 53.07), controlPoint2: CGPoint(x: 7.8, y: 50.55))
        themePath.addLine(to: CGPoint(x: 12.2, y: 46.14))
        themePath.addCurve(to: CGPoint(x: 17.86, y: 46.14), controlPoint1: CGPoint(x: 13.76, y: 44.58), controlPoint2: CGPoint(x: 16.28, y: 44.57))
        themePath.addCurve(to: CGPoint(x: 17.86, y: 51.8), controlPoint1: CGPoint(x: 19.42, y: 47.7), controlPoint2: CGPoint(x: 19.43, y: 50.22))
        themePath.addLine(to: CGPoint(x: 15.03, y: 54.63))
        themePath.addLine(to: CGPoint(x: 15.03, y: 54.63))
        themePath.close()
        themePath.move(to: CGPoint(x: 51.8, y: 17.86))
        themePath.addCurve(to: CGPoint(x: 46.14, y: 17.86), controlPoint1: CGPoint(x: 50.24, y: 19.42), controlPoint2: CGPoint(x: 47.72, y: 19.43))
        themePath.addCurve(to: CGPoint(x: 46.14, y: 12.2), controlPoint1: CGPoint(x: 44.58, y: 16.3), controlPoint2: CGPoint(x: 44.57, y: 13.78))
        themePath.addLine(to: CGPoint(x: 48.97, y: 9.37))
        themePath.addCurve(to: CGPoint(x: 54.63, y: 9.37), controlPoint1: CGPoint(x: 50.53, y: 7.81), controlPoint2: CGPoint(x: 53.05, y: 7.8))
        themePath.addCurve(to: CGPoint(x: 54.63, y: 15.03), controlPoint1: CGPoint(x: 56.19, y: 10.93), controlPoint2: CGPoint(x: 56.2, y: 13.45))
        themePath.addLine(to: CGPoint(x: 51.8, y: 17.86))
        themePath.addLine(to: CGPoint(x: 51.8, y: 17.86))
        themePath.close()
        themePath.usesEvenOddFillRule = true
        color.setFill()
        themePath.fill()
    }

    @objc dynamic public class func drawInvite(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 27.9, y: 30.82))
        bezier2Path.addLine(to: CGPoint(x: 34.13, y: 33.27))
        bezier2Path.addCurve(to: CGPoint(x: 36, y: 31.94), controlPoint1: CGPoint(x: 35.16, y: 33.67), controlPoint2: CGPoint(x: 36, y: 33.08))
        bezier2Path.addLine(to: CGPoint(x: 36, y: 7.45))
        bezier2Path.addCurve(to: CGPoint(x: 34.13, y: 6.13), controlPoint1: CGPoint(x: 36, y: 6.31), controlPoint2: CGPoint(x: 35.16, y: 5.72))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 15.61))
        bezier2Path.addLine(to: CGPoint(x: 5.9, y: 14.21))
        bezier2Path.addCurve(to: CGPoint(x: 4, y: 15.59), controlPoint1: CGPoint(x: 4.83, y: 13.85), controlPoint2: CGPoint(x: 4, y: 14.47))
        bezier2Path.addLine(to: CGPoint(x: 4, y: 23.8))
        bezier2Path.addCurve(to: CGPoint(x: 5.9, y: 25.18), controlPoint1: CGPoint(x: 4, y: 24.91), controlPoint2: CGPoint(x: 4.85, y: 25.54))
        bezier2Path.addLine(to: CGPoint(x: 10, y: 23.78))
        bezier2Path.addLine(to: CGPoint(x: 14, y: 25.36))
        bezier2Path.addLine(to: CGPoint(x: 14, y: 29.92))
        bezier2Path.addCurve(to: CGPoint(x: 18.01, y: 34), controlPoint1: CGPoint(x: 14, y: 32.19), controlPoint2: CGPoint(x: 15.8, y: 34))
        bezier2Path.addLine(to: CGPoint(x: 23.99, y: 34))
        bezier2Path.addCurve(to: CGPoint(x: 27.9, y: 30.82), controlPoint1: CGPoint(x: 25.92, y: 34), controlPoint2: CGPoint(x: 27.5, y: 32.64))
        bezier2Path.close()
        bezier2Path.move(to: CGPoint(x: 16, y: 26.14))
        bezier2Path.addLine(to: CGPoint(x: 16, y: 29.92))
        bezier2Path.addCurve(to: CGPoint(x: 18.01, y: 31.96), controlPoint1: CGPoint(x: 16, y: 31.05), controlPoint2: CGPoint(x: 16.89, y: 31.96))
        bezier2Path.addLine(to: CGPoint(x: 23.99, y: 31.96))
        bezier2Path.addCurve(to: CGPoint(x: 25.99, y: 30.07), controlPoint1: CGPoint(x: 25.06, y: 31.96), controlPoint2: CGPoint(x: 25.92, y: 31.13))
        bezier2Path.addLine(to: CGPoint(x: 16, y: 26.14))
        bezier2Path.close()
    ...
    @objc dynamic public class func drawIcon_0x222_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x123_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Undo Drawing
        let undoPath = UIBezierPath()
        undoPath.move(to: CGPoint(x: 14, y: 38))
        undoPath.addCurve(to: CGPoint(x: 20, y: 32), controlPoint1: CGPoint(x: 17.31, y: 38), controlPoint2: CGPoint(x: 20, y: 35.31))
        undoPath.addCurve(to: CGPoint(x: 14, y: 26), controlPoint1: CGPoint(x: 20, y: 28.69), controlPoint2: CGPoint(x: 17.31, y: 26))
        undoPath.addCurve(to: CGPoint(x: 8, y: 32), controlPoint1: CGPoint(x: 10.69, y: 26), controlPoint2: CGPoint(x: 8, y: 28.69))
        undoPath.addCurve(to: CGPoint(x: 14, y: 38), controlPoint1: CGPoint(x: 8, y: 35.31), controlPoint2: CGPoint(x: 10.69, y: 38))
        undoPath.addLine(to: CGPoint(x: 14, y: 38))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 50, y: 38))
        undoPath.addCurve(to: CGPoint(x: 56, y: 32), controlPoint1: CGPoint(x: 53.31, y: 38), controlPoint2: CGPoint(x: 56, y: 35.31))
        undoPath.addCurve(to: CGPoint(x: 50, y: 26), controlPoint1: CGPoint(x: 56, y: 28.69), controlPoint2: CGPoint(x: 53.31, y: 26))
        undoPath.addCurve(to: CGPoint(x: 44, y: 32), controlPoint1: CGPoint(x: 46.69, y: 26), controlPoint2: CGPoint(x: 44, y: 28.69))
        undoPath.addCurve(to: CGPoint(x: 50, y: 38), controlPoint1: CGPoint(x: 44, y: 35.31), controlPoint2: CGPoint(x: 46.69, y: 38))
        undoPath.addLine(to: CGPoint(x: 50, y: 38))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 32, y: 38))
        undoPath.addCurve(to: CGPoint(x: 38, y: 32), controlPoint1: CGPoint(x: 35.31, y: 38), controlPoint2: CGPoint(x: 38, y: 35.31))
        undoPath.addCurve(to: CGPoint(x: 32, y: 26), controlPoint1: CGPoint(x: 38, y: 28.69), controlPoint2: CGPoint(x: 35.31, y: 26))
        undoPath.addCurve(to: CGPoint(x: 26, y: 32), controlPoint1: CGPoint(x: 28.69, y: 26), controlPoint2: CGPoint(x: 26, y: 28.69))
        undoPath.addCurve(to: CGPoint(x: 32, y: 38), controlPoint1: CGPoint(x: 26, y: 35.31), controlPoint2: CGPoint(x: 28.69, y: 38))
        undoPath.addLine(to: CGPoint(x: 32, y: 38))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 14, y: 20))
        undoPath.addCurve(to: CGPoint(x: 20, y: 14), controlPoint1: CGPoint(x: 17.31, y: 20), controlPoint2: CGPoint(x: 20, y: 17.31))
        undoPath.addCurve(to: CGPoint(x: 14, y: 8), controlPoint1: CGPoint(x: 20, y: 10.69), controlPoint2: CGPoint(x: 17.31, y: 8))
        undoPath.addCurve(to: CGPoint(x: 8, y: 14), controlPoint1: CGPoint(x: 10.69, y: 8), controlPoint2: CGPoint(x: 8, y: 10.69))
        undoPath.addCurve(to: CGPoint(x: 14, y: 20), controlPoint1: CGPoint(x: 8, y: 17.31), controlPoint2: CGPoint(x: 10.69, y: 20))
        undoPath.addLine(to: CGPoint(x: 14, y: 20))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 50, y: 20))
        undoPath.addCurve(to: CGPoint(x: 56, y: 14), controlPoint1: CGPoint(x: 53.31, y: 20), controlPoint2: CGPoint(x: 56, y: 17.31))
        undoPath.addCurve(to: CGPoint(x: 50, y: 8), controlPoint1: CGPoint(x: 56, y: 10.69), controlPoint2: CGPoint(x: 53.31, y: 8))
        undoPath.addCurve(to: CGPoint(x: 44, y: 14), controlPoint1: CGPoint(x: 46.69, y: 8), controlPoint2: CGPoint(x: 44, y: 10.69))
        undoPath.addCurve(to: CGPoint(x: 50, y: 20), controlPoint1: CGPoint(x: 44, y: 17.31), controlPoint2: CGPoint(x: 46.69, y: 20))
        undoPath.addLine(to: CGPoint(x: 50, y: 20))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 32, y: 20))
        undoPath.addCurve(to: CGPoint(x: 38, y: 14), controlPoint1: CGPoint(x: 35.31, y: 20), controlPoint2: CGPoint(x: 38, y: 17.31))
        undoPath.addCurve(to: CGPoint(x: 32, y: 8), controlPoint1: CGPoint(x: 38, y: 10.69), controlPoint2: CGPoint(x: 35.31, y: 8))
        undoPath.addCurve(to: CGPoint(x: 26, y: 14), controlPoint1: CGPoint(x: 28.69, y: 8), controlPoint2: CGPoint(x: 26, y: 10.69))
        undoPath.addCurve(to: CGPoint(x: 32, y: 20), controlPoint1: CGPoint(x: 26, y: 17.31), controlPoint2: CGPoint(x: 28.69, y: 20))
        undoPath.addLine(to: CGPoint(x: 32, y: 20))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 14, y: 56))
        undoPath.addCurve(to: CGPoint(x: 20, y: 50), controlPoint1: CGPoint(x: 17.31, y: 56), controlPoint2: CGPoint(x: 20, y: 53.31))
        undoPath.addCurve(to: CGPoint(x: 14, y: 44), controlPoint1: CGPoint(x: 20, y: 46.69), controlPoint2: CGPoint(x: 17.31, y: 44))
        undoPath.addCurve(to: CGPoint(x: 8, y: 50), controlPoint1: CGPoint(x: 10.69, y: 44), controlPoint2: CGPoint(x: 8, y: 46.69))
        undoPath.addCurve(to: CGPoint(x: 14, y: 56), controlPoint1: CGPoint(x: 8, y: 53.31), controlPoint2: CGPoint(x: 10.69, y: 56))
        undoPath.addLine(to: CGPoint(x: 14, y: 56))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 50, y: 56))
        undoPath.addCurve(to: CGPoint(x: 56, y: 50), controlPoint1: CGPoint(x: 53.31, y: 56), controlPoint2: CGPoint(x: 56, y: 53.31))
        undoPath.addCurve(to: CGPoint(x: 50, y: 44), controlPoint1: CGPoint(x: 56, y: 46.69), controlPoint2: CGPoint(x: 53.31, y: 44))
        undoPath.addCurve(to: CGPoint(x: 44, y: 50), controlPoint1: CGPoint(x: 46.69, y: 44), controlPoint2: CGPoint(x: 44, y: 46.69))
        undoPath.addCurve(to: CGPoint(x: 50, y: 56), controlPoint1: CGPoint(x: 44, y: 53.31), controlPoint2: CGPoint(x: 46.69, y: 56))
        undoPath.addLine(to: CGPoint(x: 50, y: 56))
        undoPath.close()
        undoPath.move(to: CGPoint(x: 32, y: 56))
        undoPath.addCurve(to: CGPoint(x: 38, y: 50), controlPoint1: CGPoint(x: 35.31, y: 56), controlPoint2: CGPoint(x: 38, y: 53.31))
        undoPath.addCurve(to: CGPoint(x: 32, y: 44), controlPoint1: CGPoint(x: 38, y: 46.69), controlPoint2: CGPoint(x: 35.31, y: 44))
        undoPath.addCurve(to: CGPoint(x: 26, y: 50), controlPoint1: CGPoint(x: 28.69, y: 44), controlPoint2: CGPoint(x: 26, y: 46.69))
        undoPath.addCurve(to: CGPoint(x: 32, y: 56), controlPoint1: CGPoint(x: 26, y: 53.31), controlPoint2: CGPoint(x: 28.69, y: 56))
        undoPath.addLine(to: CGPoint(x: 32, y: 56))
        undoPath.close()
        color.setFill()
        undoPath.fill()
    }

    @objc dynamic public class func drawIcon_0x128_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x113_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    /// up arrow
    @objc dynamic public class func drawIcon_0x814_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 5.88, y: 50.88))
        bezierPath.addLine(to: CGPoint(x: 32, y: 24.76))
        bezierPath.addLine(to: CGPoint(x: 58.12, y: 50.88))
        bezierPath.addLine(to: CGPoint(x: 64, y: 45))
        bezierPath.addLine(to: CGPoint(x: 32, y: 13))
        bezierPath.addLine(to: CGPoint(x: 0, y: 45))
        bezierPath.addLine(to: CGPoint(x: 5.88, y: 50.88))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }
    
    @objc dynamic public class func drawIcon_0x121_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x111_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x226_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x131_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x164_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x132_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x1420_28pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 0, y: 0, width: 56, height: 56))
        color.setFill()
        ovalPath.fill()


        //// Contact Drawing
        let contactPath = UIBezierPath()
        contactPath.move(to: CGPoint(x: 35.22, y: 32))
        contactPath.addLine(to: CGPoint(x: 35.99, y: 32))
        contactPath.addCurve(to: CGPoint(x: 42, y: 38), controlPoint1: CGPoint(x: 39.31, y: 32), controlPoint2: CGPoint(x: 42, y: 34.69))
        contactPath.addLine(to: CGPoint(x: 42, y: 40.54))
        contactPath.addLine(to: CGPoint(x: 42, y: 40.54))
        contactPath.addCurve(to: CGPoint(x: 28, y: 44), controlPoint1: CGPoint(x: 37.82, y: 42.75), controlPoint2: CGPoint(x: 33.06, y: 44))
        contactPath.addCurve(to: CGPoint(x: 14, y: 40.54), controlPoint1: CGPoint(x: 22.94, y: 44), controlPoint2: CGPoint(x: 18.18, y: 42.75))
        contactPath.addLine(to: CGPoint(x: 14, y: 38))
        contactPath.addCurve(to: CGPoint(x: 20.01, y: 32), controlPoint1: CGPoint(x: 14, y: 34.69), controlPoint2: CGPoint(x: 16.68, y: 32))
        contactPath.addLine(to: CGPoint(x: 20.78, y: 32))
        contactPath.addCurve(to: CGPoint(x: 28, y: 34), controlPoint1: CGPoint(x: 22.89, y: 33.27), controlPoint2: CGPoint(x: 25.36, y: 34))
        contactPath.addCurve(to: CGPoint(x: 35.22, y: 32), controlPoint1: CGPoint(x: 30.64, y: 34), controlPoint2: CGPoint(x: 33.11, y: 33.27))
        contactPath.addLine(to: CGPoint(x: 35.22, y: 32))
        contactPath.close()
        contactPath.move(to: CGPoint(x: 28, y: 28))
        contactPath.addCurve(to: CGPoint(x: 36, y: 20), controlPoint1: CGPoint(x: 32.42, y: 28), controlPoint2: CGPoint(x: 36, y: 24.42))
        contactPath.addCurve(to: CGPoint(x: 28, y: 12), controlPoint1: CGPoint(x: 36, y: 15.58), controlPoint2: CGPoint(x: 32.42, y: 12))
        contactPath.addCurve(to: CGPoint(x: 20, y: 20), controlPoint1: CGPoint(x: 23.58, y: 12), controlPoint2: CGPoint(x: 20, y: 15.58))
        contactPath.addCurve(to: CGPoint(x: 28, y: 28), controlPoint1: CGPoint(x: 20, y: 24.42), controlPoint2: CGPoint(x: 23.58, y: 28))
        contactPath.close()
        contactPath.usesEvenOddFillRule = true
        UIColor.white.setFill()
        contactPath.fill()
    }

    @objc dynamic public class func drawIcon_0x110_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x103_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x211_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x142_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x152_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x185_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x146_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x227_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x159_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x228_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Stop Drawing
        let stopPath = UIBezierPath(rect: CGRect(x: 8, y: 8, width: 48, height: 48))
        color.setFill()
        stopPath.fill()
    }

    @objc dynamic public class func drawIcon_0x154_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x148_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x229_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x230_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x149_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x240_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x244_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x246_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x245_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x242_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x247_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x243_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x139_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x186_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x183_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x184_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x188_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x135_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x134_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x127_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x237_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x236_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Keyboard Drawing
        let keyboardPath = UIBezierPath()
        keyboardPath.move(to: CGPoint(x: 32, y: 16))
        keyboardPath.addLine(to: CGPoint(x: 48, y: 16))
        keyboardPath.addLine(to: CGPoint(x: 48, y: 8))
        keyboardPath.addLine(to: CGPoint(x: 8, y: 8))
        keyboardPath.addLine(to: CGPoint(x: 8, y: 16))
        keyboardPath.addLine(to: CGPoint(x: 24, y: 16))
        keyboardPath.addLine(to: CGPoint(x: 24, y: 56))
        keyboardPath.addLine(to: CGPoint(x: 32, y: 56))
        keyboardPath.addLine(to: CGPoint(x: 32, y: 16))
        keyboardPath.close()
        keyboardPath.move(to: CGPoint(x: 60, y: 0))
        keyboardPath.addLine(to: CGPoint(x: 64, y: 0))
        keyboardPath.addLine(to: CGPoint(x: 64, y: 64))
        keyboardPath.addLine(to: CGPoint(x: 60, y: 64))
        keyboardPath.addLine(to: CGPoint(x: 60, y: 0))
        keyboardPath.close()
        keyboardPath.usesEvenOddFillRule = true
        color.setFill()
        keyboardPath.fill()
    }

    @objc dynamic public class func drawIcon_0x238_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Backspace Drawing
        let backspacePath = UIBezierPath()
        backspacePath.move(to: CGPoint(x: 1.16, y: 35.85))
        backspacePath.addCurve(to: CGPoint(x: 1.16, y: 30.15), controlPoint1: CGPoint(x: -0.39, y: 34.27), controlPoint2: CGPoint(x: -0.38, y: 31.71))
        backspacePath.addLine(to: CGPoint(x: 20.23, y: 10.88))
        backspacePath.addCurve(to: CGPoint(x: 24.78, y: 9), controlPoint1: CGPoint(x: 21.26, y: 9.84), controlPoint2: CGPoint(x: 23.3, y: 9))
        backspacePath.addLine(to: CGPoint(x: 54.7, y: 9))
        backspacePath.addCurve(to: CGPoint(x: 64, y: 18.31), controlPoint1: CGPoint(x: 59.84, y: 9), controlPoint2: CGPoint(x: 64, y: 13.18))
        backspacePath.addLine(to: CGPoint(x: 64, y: 47.69))
        backspacePath.addCurve(to: CGPoint(x: 54.7, y: 57), controlPoint1: CGPoint(x: 64, y: 52.83), controlPoint2: CGPoint(x: 59.83, y: 57))
        backspacePath.addLine(to: CGPoint(x: 24.78, y: 57))
        backspacePath.addCurve(to: CGPoint(x: 20.23, y: 55.12), controlPoint1: CGPoint(x: 23.29, y: 57), controlPoint2: CGPoint(x: 21.25, y: 56.15))
        backspacePath.addLine(to: CGPoint(x: 1.16, y: 35.85))
        backspacePath.close()
        backspacePath.move(to: CGPoint(x: 42.05, y: 32.94))
        backspacePath.addLine(to: CGPoint(x: 50.06, y: 24.91))
        backspacePath.addCurve(to: CGPoint(x: 50.05, y: 21.96), controlPoint1: CGPoint(x: 50.85, y: 24.12), controlPoint2: CGPoint(x: 50.87, y: 22.78))
        backspacePath.addCurve(to: CGPoint(x: 47.1, y: 21.95), controlPoint1: CGPoint(x: 49.23, y: 21.13), controlPoint2: CGPoint(x: 47.91, y: 21.13))
        backspacePath.addLine(to: CGPoint(x: 39.08, y: 29.97))
        backspacePath.addLine(to: CGPoint(x: 31.07, y: 21.95))
        backspacePath.addCurve(to: CGPoint(x: 28.12, y: 21.96), controlPoint1: CGPoint(x: 30.28, y: 21.15), controlPoint2: CGPoint(x: 28.94, y: 21.14))
        backspacePath.addCurve(to: CGPoint(x: 28.11, y: 24.91), controlPoint1: CGPoint(x: 27.29, y: 22.78), controlPoint2: CGPoint(x: 27.3, y: 24.1))
        backspacePath.addLine(to: CGPoint(x: 36.12, y: 32.94))
        backspacePath.addLine(to: CGPoint(x: 28.11, y: 40.96))
        backspacePath.addCurve(to: CGPoint(x: 28.12, y: 43.92), controlPoint1: CGPoint(x: 27.32, y: 41.75), controlPoint2: CGPoint(x: 27.3, y: 43.1))
        backspacePath.addCurve(to: CGPoint(x: 31.07, y: 43.93), controlPoint1: CGPoint(x: 28.94, y: 44.74), controlPoint2: CGPoint(x: 30.26, y: 44.74))
        backspacePath.addLine(to: CGPoint(x: 39.08, y: 35.9))
        backspacePath.addLine(to: CGPoint(x: 47.1, y: 43.93))
        backspacePath.addCurve(to: CGPoint(x: 50.05, y: 43.92), controlPoint1: CGPoint(x: 47.89, y: 44.72), controlPoint2: CGPoint(x: 49.23, y: 44.74))
        backspacePath.addCurve(to: CGPoint(x: 50.06, y: 40.96), controlPoint1: CGPoint(x: 50.87, y: 43.09), controlPoint2: CGPoint(x: 50.87, y: 41.77))
        backspacePath.addLine(to: CGPoint(x: 42.05, y: 32.94))
        backspacePath.close()
        backspacePath.move(to: CGPoint(x: 5.81, y: 34.9))
        backspacePath.addCurve(to: CGPoint(x: 5.81, y: 31.1), controlPoint1: CGPoint(x: 4.77, y: 33.85), controlPoint2: CGPoint(x: 4.77, y: 32.15))
        backspacePath.addLine(to: CGPoint(x: 22.55, y: 14.19))
        backspacePath.addCurve(to: CGPoint(x: 24.82, y: 13.24), controlPoint1: CGPoint(x: 23.07, y: 13.66), controlPoint2: CGPoint(x: 24.06, y: 13.24))
        backspacePath.addLine(to: CGPoint(x: 54.49, y: 13.24))
        backspacePath.addCurve(to: CGPoint(x: 59.81, y: 18.57), controlPoint1: CGPoint(x: 57.43, y: 13.24), controlPoint2: CGPoint(x: 59.81, y: 15.65))
        backspacePath.addLine(to: CGPoint(x: 59.81, y: 47.43))
        backspacePath.addCurve(to: CGPoint(x: 54.49, y: 52.76), controlPoint1: CGPoint(x: 59.81, y: 50.38), controlPoint2: CGPoint(x: 57.43, y: 52.76))
        backspacePath.addLine(to: CGPoint(x: 24.82, y: 52.76))
        backspacePath.addCurve(to: CGPoint(x: 22.55, y: 51.81), controlPoint1: CGPoint(x: 24.09, y: 52.76), controlPoint2: CGPoint(x: 23.08, y: 52.35))
        backspacePath.addLine(to: CGPoint(x: 5.81, y: 34.9))
        backspacePath.close()
        backspacePath.usesEvenOddFillRule = true
        color.setFill()
        backspacePath.fill()
    }

    @objc dynamic public class func drawIcon_0x250_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x251_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x252_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x253_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x254_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x255_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x256_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x124_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x239_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawSecond(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawMinute(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawHour(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawDay(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x737_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 32, y: 60))
        bezierPath.addCurve(to: CGPoint(x: 60, y: 32), controlPoint1: CGPoint(x: 47.46, y: 60), controlPoint2: CGPoint(x: 60, y: 47.46))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 4), controlPoint1: CGPoint(x: 60, y: 16.54), controlPoint2: CGPoint(x: 47.46, y: 4))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 32), controlPoint1: CGPoint(x: 16.54, y: 4), controlPoint2: CGPoint(x: 4, y: 16.54))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 60), controlPoint1: CGPoint(x: 4, y: 47.46), controlPoint2: CGPoint(x: 16.54, y: 60))
        bezierPath.close()
        ...
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 22, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 22), controlPoint1: CGPoint(x: 23.1, y: 24), controlPoint2: CGPoint(x: 24, y: 23.1))
        bezierPath.addCurve(to: CGPoint(x: 22, y: 20), controlPoint1: CGPoint(x: 24, y: 20.9), controlPoint2: CGPoint(x: 23.1, y: 20))
        bezierPath.addCurve(to: CGPoint(x: 20, y: 22), controlPoint1: CGPoint(x: 20.9, y: 20), controlPoint2: CGPoint(x: 20, y: 20.9))
        bezierPath.addCurve(to: CGPoint(x: 22, y: 24), controlPoint1: CGPoint(x: 20, y: 23.1), controlPoint2: CGPoint(x: 20.9, y: 24))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 22, y: 28))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 22), controlPoint1: CGPoint(x: 18.69, y: 28), controlPoint2: CGPoint(x: 16, y: 25.31))
        bezierPath.addCurve(to: CGPoint(x: 22, y: 16), controlPoint1: CGPoint(x: 16, y: 18.69), controlPoint2: CGPoint(x: 18.69, y: 16))
        bezierPath.addCurve(to: CGPoint(x: 28, y: 22), controlPoint1: CGPoint(x: 25.31, y: 16), controlPoint2: CGPoint(x: 28, y: 18.69))
        bezierPath.addCurve(to: CGPoint(x: 22, y: 28), controlPoint1: CGPoint(x: 28, y: 25.31), controlPoint2: CGPoint(x: 25.31, y: 28))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 42, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 44, y: 22), controlPoint1: CGPoint(x: 43.1, y: 24), controlPoint2: CGPoint(x: 44, y: 23.1))
        bezierPath.addCurve(to: CGPoint(x: 42, y: 20), controlPoint1: CGPoint(x: 44, y: 20.9), controlPoint2: CGPoint(x: 43.1, y: 20))
        bezierPath.addCurve(to: CGPoint(x: 40, y: 22), controlPoint1: CGPoint(x: 40.9, y: 20), controlPoint2: CGPoint(x: 40, y: 20.9))
        bezierPath.addCurve(to: CGPoint(x: 42, y: 24), controlPoint1: CGPoint(x: 40, y: 23.1), controlPoint2: CGPoint(x: 40.9, y: 24))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 42, y: 28))
        bezierPath.addCurve(to: CGPoint(x: 36, y: 22), controlPoint1: CGPoint(x: 38.69, y: 28), controlPoint2: CGPoint(x: 36, y: 25.31))
        bezierPath.addCurve(to: CGPoint(x: 42, y: 16), controlPoint1: CGPoint(x: 36, y: 18.69), controlPoint2: CGPoint(x: 38.69, y: 16))
        bezierPath.addCurve(to: CGPoint(x: 48, y: 22), controlPoint1: CGPoint(x: 45.31, y: 16), controlPoint2: CGPoint(x: 48, y: 18.69))
        bezierPath.addCurve(to: CGPoint(x: 42, y: 28), controlPoint1: CGPoint(x: 48, y: 25.31), controlPoint2: CGPoint(x: 45.31, y: 28))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 52))
        bezierPath.addCurve(to: CGPoint(x: 16.14, y: 40), controlPoint1: CGPoint(x: 24.17, y: 52), controlPoint2: CGPoint(x: 17.64, y: 46.85))
        bezierPath.addLine(to: CGPoint(x: 47.86, y: 40))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 52), controlPoint1: CGPoint(x: 46.36, y: 46.85), controlPoint2: CGPoint(x: 39.83, y: 52))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 52.8, y: 36))
        bezierPath.addLine(to: CGPoint(x: 47.86, y: 36))
        bezierPath.addLine(to: CGPoint(x: 16.14, y: 36))
        bezierPath.addLine(to: CGPoint(x: 11.2, y: 36))
        bezierPath.addLine(to: CGPoint(x: 12.26, y: 40.86))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 56), controlPoint1: CGPoint(x: 14.19, y: 49.64), controlPoint2: CGPoint(x: 22.49, y: 56))
        bezierPath.addCurve(to: CGPoint(x: 51.73, y: 40.86), controlPoint1: CGPoint(x: 41.51, y: 56), controlPoint2: CGPoint(x: 49.81, y: 49.64))
        bezierPath.addLine(to: CGPoint(x: 52.8, y: 36))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x654_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 4.68, y: 29.63))
        bezierPath.addCurve(to: CGPoint(x: 4.68, y: 26.12), controlPoint1: CGPoint(x: 3.71, y: 28.66), controlPoint2: CGPoint(x: 3.71, y: 27.09))
        bezierPath.addLine(to: CGPoint(x: 24.69, y: 6.06))
        bezierPath.addCurve(to: CGPoint(x: 53.89, y: 6.06), controlPoint1: CGPoint(x: 32.75, y: -2.02), controlPoint2: CGPoint(x: 45.83, y: -2.02))
        bezierPath.addCurve(to: CGPoint(x: 53.89, y: 35.36), controlPoint1: CGPoint(x: 61.97, y: 14.15), controlPoint2: CGPoint(x: 61.97, y: 27.26))
        bezierPath.addLine(to: CGPoint(x: 48.17, y: 41.1))
        bezierPath.addLine(to: CGPoint(x: 29.58, y: 59.72))
        bezierPath.addCurve(to: CGPoint(x: 8.97, y: 59.72), controlPoint1: CGPoint(x: 23.89, y: 65.43), controlPoint2: CGPoint(x: 14.66, y: 65.42))
        bezierPath.addCurve(to: CGPoint(x: 8.96, y: 39.01), controlPoint1: CGPoint(x: 3.26, y: 54), controlPoint2: CGPoint(x: 3.26, y: 44.73))
        bezierPath.addLine(to: CGPoint(x: 14.69, y: 33.28))
        bezierPath.addLine(to: CGPoint(x: 33.29, y: 14.63))
        bezierPath.addCurve(to: CGPoint(x: 45.31, y: 14.65), controlPoint1: CGPoint(x: 36.61, y: 11.3), controlPoint2: CGPoint(x: 41.98, y: 11.31))
        bezierPath.addCurve(to: CGPoint(x: 45.34, y: 26.74), controlPoint1: CGPoint(x: 48.65, y: 18), controlPoint2: CGPoint(x: 48.67, y: 23.4))
        bezierPath.addLine(to: CGPoint(x: 25.27, y: 46.85))
        bezierPath.addCurve(to: CGPoint(x: 21.8, y: 46.85), controlPoint1: CGPoint(x: 24.31, y: 47.82), controlPoint2: CGPoint(x: 22.76, y: 47.82))
        bezierPath.addCurve(to: CGPoint(x: 21.8, y: 43.34), controlPoint1: CGPoint(x: 20.84, y: 45.89), controlPoint2: CGPoint(x: 20.84, y: 44.31))
        bezierPath.addLine(to: CGPoint(x: 41.87, y: 23.23))
        bezierPath.addCurve(to: CGPoint(x: 41.85, y: 18.17), controlPoint1: CGPoint(x: 43.27, y: 21.82), controlPoint2: CGPoint(x: 43.25, y: 19.58))
        bezierPath.addCurve(to: CGPoint(x: 36.76, y: 18.14), controlPoint1: CGPoint(x: 40.43, y: 16.75), controlPoint2: CGPoint(x: 38.17, y: 16.74))
        bezierPath.addLine(to: CGPoint(x: 18.15, y: 36.79))
        bezierPath.addLine(to: CGPoint(x: 12.43, y: 42.53))
        bezierPath.addCurve(to: CGPoint(x: 12.43, y: 56.2), controlPoint1: CGPoint(x: 8.66, y: 46.31), controlPoint2: CGPoint(x: 8.66, y: 52.43))
        bezierPath.addCurve(to: CGPoint(x: 26.12, y: 56.21), controlPoint1: CGPoint(x: 16.21, y: 59.99), controlPoint2: CGPoint(x: 22.35, y: 59.99))
        bezierPath.addLine(to: CGPoint(x: 44.7, y: 37.58))
        bezierPath.addLine(to: CGPoint(x: 50.43, y: 31.85))
        bezierPath.addCurve(to: CGPoint(x: 50.42, y: 9.57), controlPoint1: CGPoint(x: 56.57, y: 25.69), controlPoint2: CGPoint(x: 56.57, y: 15.73))
        bezierPath.addCurve(to: CGPoint(x: 28.16, y: 9.57), controlPoint1: CGPoint(x: 44.28, y: 3.42), controlPoint2: CGPoint(x: 34.3, y: 3.42))
        bezierPath.addLine(to: CGPoint(x: 8.14, y: 29.63))
        bezierPath.addCurve(to: CGPoint(x: 4.68, y: 29.63), controlPoint1: CGPoint(x: 7.18, y: 30.59), controlPoint2: CGPoint(x: 5.63, y: 30.59))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        color.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x643_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 48, y: 36))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 20), controlPoint1: CGPoint(x: 48, y: 27.16), controlPoint2: CGPoint(x: 40.84, y: 20))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 36), controlPoint1: CGPoint(x: 23.16, y: 20), controlPoint2: CGPoint(x: 16, y: 27.16))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 52), controlPoint1: CGPoint(x: 16, y: 44.84), controlPoint2: CGPoint(x: 23.16, y: 52))
        bezierPath.addCurve(to: CGPoint(x: 48, y: 36), controlPoint1: CGPoint(x: 40.84, y: 52), controlPoint2: CGPoint(x: 48, y: 44.84))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 52, y: 36))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 56), controlPoint1: CGPoint(x: 52, y: 47.05), controlPoint2: CGPoint(x: 43.05, y: 56))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 36), controlPoint1: CGPoint(x: 20.95, y: 56), controlPoint2: CGPoint(x: 12, y: 47.05))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 16), controlPoint1: CGPoint(x: 12, y: 24.95), controlPoint2: CGPoint(x: 20.95, y: 16))
        bezierPath.addCurve(to: CGPoint(x: 52, y: 36), controlPoint1: CGPoint(x: 43.05, y: 16), controlPoint2: CGPoint(x: 52, y: 24.95))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 28))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 36), controlPoint1: CGPoint(x: 27.58, y: 28), controlPoint2: CGPoint(x: 24, y: 31.58))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 44), controlPoint1: CGPoint(x: 24, y: 40.42), controlPoint2: CGPoint(x: 27.58, y: 44))
        bezierPath.addCurve(to: CGPoint(x: 40, y: 36), controlPoint1: CGPoint(x: 36.42, y: 44), controlPoint2: CGPoint(x: 40, y: 40.42))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 28), controlPoint1: CGPoint(x: 40, y: 31.58), controlPoint2: CGPoint(x: 36.42, y: 28))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 44, y: 36), controlPoint1: CGPoint(x: 38.63, y: 24), controlPoint2: CGPoint(x: 44, y: 29.37))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 48), controlPoint1: CGPoint(x: 44, y: 42.63), controlPoint2: CGPoint(x: 38.63, y: 48))
        bezierPath.addCurve(to: CGPoint(x: 20, y: 36), controlPoint1: CGPoint(x: 25.37, y: 48), controlPoint2: CGPoint(x: 20, y: 42.63))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 24), controlPoint1: CGPoint(x: 20, y: 29.37), controlPoint2: CGPoint(x: 25.37, y: 24))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 23.07, y: 4.78))
        bezierPath.addLine(to: CGPoint(x: 21.52, y: 12))
        bezierPath.addLine(to: CGPoint(x: 7.98, y: 12))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 16.02), controlPoint1: CGPoint(x: 5.79, y: 12), controlPoint2: CGPoint(x: 4, y: 13.8))
        bezierPath.addLine(to: CGPoint(x: 4, y: 55.98))
        bezierPath.addCurve(to: CGPoint(x: 7.98, y: 60), controlPoint1: CGPoint(x: 4, y: 58.21), controlPoint2: CGPoint(x: 5.78, y: 60))
        bezierPath.addLine(to: CGPoint(x: 56.02, y: 60))
        bezierPath.addCurve(to: CGPoint(x: 60, y: 55.98), controlPoint1: CGPoint(x: 58.21, y: 60), controlPoint2: CGPoint(x: 60, y: 58.2))
        bezierPath.addLine(to: CGPoint(x: 60, y: 16.02))
        bezierPath.addCurve(to: CGPoint(x: 56.02, y: 12), controlPoint1: CGPoint(x: 60, y: 13.79), controlPoint2: CGPoint(x: 58.22, y: 12))
        bezierPath.addLine(to: CGPoint(x: 42.48, y: 12))
        bezierPath.addLine(to: CGPoint(x: 40.93, y: 4.78))
        bezierPath.addCurve(to: CGPoint(x: 40.04, y: 4), controlPoint1: CGPoint(x: 40.86, y: 4.42), controlPoint2: CGPoint(x: 40.34, y: 4))
        bezierPath.addLine(to: CGPoint(x: 23.96, y: 4))
        bezierPath.addCurve(to: CGPoint(x: 23.07, y: 4.78), controlPoint1: CGPoint(x: 23.69, y: 4), controlPoint2: CGPoint(x: 23.14, y: 4.45))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 19.16, y: 3.94))
        bezierPath.addCurve(to: CGPoint(x: 23.96, y: 0), controlPoint1: CGPoint(x: 19.62, y: 1.76), controlPoint2: CGPoint(x: 21.8, y: 0))
        bezierPath.addLine(to: CGPoint(x: 40.04, y: 0))
        bezierPath.addCurve(to: CGPoint(x: 44.84, y: 3.94), controlPoint1: CGPoint(x: 42.23, y: 0), controlPoint2: CGPoint(x: 44.37, y: 1.74))
        bezierPath.addLine(to: CGPoint(x: 45.71, y: 8))
        bezierPath.addLine(to: CGPoint(x: 56.02, y: 8))
        bezierPath.addCurve(to: CGPoint(x: 64, y: 16.02), controlPoint1: CGPoint(x: 60.43, y: 8), controlPoint2: CGPoint(x: 64, y: 11.59))
        bezierPath.addLine(to: CGPoint(x: 64, y: 55.98))
        bezierPath.addCurve(to: CGPoint(x: 56.02, y: 64), controlPoint1: CGPoint(x: 64, y: 60.41), controlPoint2: CGPoint(x: 60.42, y: 64))
        bezierPath.addLine(to: CGPoint(x: 7.98, y: 64))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 55.98), controlPoint1: CGPoint(x: 3.57, y: 64), controlPoint2: CGPoint(x: 0, y: 60.41))
        bezierPath.addLine(to: CGPoint(x: 0, y: 16.02))
        bezierPath.addCurve(to: CGPoint(x: 7.98, y: 8), controlPoint1: CGPoint(x: 0, y: 11.59), controlPoint2: CGPoint(x: 3.58, y: 8))
        bezierPath.addLine(to: CGPoint(x: 18.29, y: 8))
        bezierPath.addLine(to: CGPoint(x: 19.16, y: 3.94))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x645_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier 4 Drawing
        let bezier4Path = UIBezierPath()
        bezier4Path.move(to: CGPoint(x: 42, y: 16))
        bezier4Path.addCurve(to: CGPoint(x: 36, y: 22), controlPoint1: CGPoint(x: 38.69, y: 16), controlPoint2: CGPoint(x: 36, y: 18.69))
        bezier4Path.addCurve(to: CGPoint(x: 42, y: 28), controlPoint1: CGPoint(x: 36, y: 25.31), controlPoint2: CGPoint(x: 38.69, y: 28))
        bezier4Path.addCurve(to: CGPoint(x: 48, y: 22), controlPoint1: CGPoint(x: 45.31, y: 28), controlPoint2: CGPoint(x: 48, y: 25.31))
        bezier4Path.addCurve(to: CGPoint(x: 42, y: 16), controlPoint1: CGPoint(x: 48, y: 18.69), controlPoint2: CGPoint(x: 45.31, y: 16))
        bezier4Path.close()
        bezier4Path.move(to: CGPoint(x: 52, y: 22))
        bezier4Path.addCurve(to: CGPoint(x: 42, y: 32), controlPoint1: CGPoint(x: 52, y: 27.52), controlPoint2: CGPoint(x: 47.52, y: 32))
        bezier4Path.addCurve(to: CGPoint(x: 32, y: 22), controlPoint1: CGPoint(x: 36.48, y: 32), controlPoint2: CGPoint(x: 32, y: 27.52))
        bezier4Path.addCurve(to: CGPoint(x: 42, y: 12), controlPoint1: CGPoint(x: 32, y: 16.48), controlPoint2: CGPoint(x: 36.48, y: 12))
        bezier4Path.addCurve(to: CGPoint(x: 52, y: 22), controlPoint1: CGPoint(x: 47.52, y: 12), controlPoint2: CGPoint(x: 52, y: 16.48))
        bezier4Path.close()
        bezier4Path.move(to: CGPoint(x: 4.16, y: 4))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 44.21), controlPoint1: CGPoint(x: 4, y: 4), controlPoint2: CGPoint(x: 4, y: 27.65))
        bezier4Path.addCurve(to: CGPoint(x: 23.94, y: 36.04), controlPoint1: CGPoint(x: 8.67, y: 42.3), controlPoint2: CGPoint(x: 23.94, y: 36.04))
        bezier4Path.addCurve(to: CGPoint(x: 60, y: 49.95), controlPoint1: CGPoint(x: 23.94, y: 36.04), controlPoint2: CGPoint(x: 52.02, y: 46.87))
        bezier4Path.addCurve(to: CGPoint(x: 60, y: 4), controlPoint1: CGPoint(x: 60, y: 33.84), controlPoint2: CGPoint(x: 60, y: 4))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 4), controlPoint1: CGPoint(x: 60, y: 3.99), controlPoint2: CGPoint(x: 4, y: 4))
        bezier4Path.addLine(to: CGPoint(x: 4.16, y: 4))
        bezier4Path.close()
        bezier4Path.move(to: CGPoint(x: 23.94, y: 40.45))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 48.55), controlPoint1: CGPoint(x: 23.94, y: 40.45), controlPoint2: CGPoint(x: 8.67, y: 46.66))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 57.45), controlPoint1: CGPoint(x: 4, y: 52.29), controlPoint2: CGPoint(x: 4, y: 55.42))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 60), controlPoint1: CGPoint(x: 4, y: 59.07), controlPoint2: CGPoint(x: 4, y: 60))
        bezier4Path.addCurve(to: CGPoint(x: 60, y: 60), controlPoint1: CGPoint(x: 4, y: 60.01), controlPoint2: CGPoint(x: 60, y: 60))
        bezier4Path.addCurve(to: CGPoint(x: 60, y: 54.18), controlPoint1: CGPoint(x: 60, y: 60), controlPoint2: CGPoint(x: 60, y: 57.76))
        bezier4Path.addCurve(to: CGPoint(x: 23.94, y: 40.45), controlPoint1: CGPoint(x: 52.02, y: 51.14), controlPoint2: CGPoint(x: 23.94, y: 40.45))
        bezier4Path.close()
        bezier4Path.move(to: CGPoint(x: 64, y: 4))
        bezier4Path.addLine(to: CGPoint(x: 64, y: 60))
        bezier4Path.addCurve(to: CGPoint(x: 60, y: 64), controlPoint1: CGPoint(x: 64, y: 62.21), controlPoint2: CGPoint(x: 62.22, y: 64))
        bezier4Path.addLine(to: CGPoint(x: 4, y: 64))
        bezier4Path.addCurve(to: CGPoint(x: 0, y: 60), controlPoint1: CGPoint(x: 1.79, y: 64), controlPoint2: CGPoint(x: 0, y: 62.22))
        bezier4Path.addLine(to: CGPoint(x: 0, y: 4))
        bezier4Path.addCurve(to: CGPoint(x: 3.08, y: 0.11), controlPoint1: CGPoint(x: 0, y: 2.11), controlPoint2: CGPoint(x: 1.31, y: 0.52))
        bezier4Path.addCurve(to: CGPoint(x: 4, y: 0), controlPoint1: CGPoint(x: 3.38, y: 0.04), controlPoint2: CGPoint(x: 3.69, y: 0))
        bezier4Path.addLine(to: CGPoint(x: 60, y: 0))
        bezier4Path.addCurve(to: CGPoint(x: 64, y: 4), controlPoint1: CGPoint(x: 62.21, y: 0), controlPoint2: CGPoint(x: 64, y: 1.78))
        bezier4Path.close()
        color.setFill()
        bezier4Path.fill()
    }

    @objc dynamic public class func drawIcon_0x644_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        ...
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 52))
        bezierPath.addCurve(to: CGPoint(x: 52, y: 32), controlPoint1: CGPoint(x: 43.05, y: 52), controlPoint2: CGPoint(x: 52, y: 43.05))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 12), controlPoint1: CGPoint(x: 52, y: 20.95), controlPoint2: CGPoint(x: 43.05, y: 12))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 32), controlPoint1: CGPoint(x: 20.95, y: 12), controlPoint2: CGPoint(x: 12, y: 20.95))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 52), controlPoint1: CGPoint(x: 12, y: 43.05), controlPoint2: CGPoint(x: 20.95, y: 52))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 56))
        bezierPath.addCurve(to: CGPoint(x: 8, y: 32), controlPoint1: CGPoint(x: 18.75, y: 56), controlPoint2: CGPoint(x: 8, y: 45.25))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 8), controlPoint1: CGPoint(x: 8, y: 18.75), controlPoint2: CGPoint(x: 18.75, y: 8))
        bezierPath.addCurve(to: CGPoint(x: 56, y: 32), controlPoint1: CGPoint(x: 45.25, y: 8), controlPoint2: CGPoint(x: 56, y: 18.75))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 56), controlPoint1: CGPoint(x: 56, y: 45.25), controlPoint2: CGPoint(x: 45.25, y: 56))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x719_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 32, y: 8))
        bezierPath.addLine(to: CGPoint(x: 36, y: 8))
        bezierPath.addLine(to: CGPoint(x: 36, y: 56))
        bezierPath.addLine(to: CGPoint(x: 32, y: 56))
        bezierPath.addLine(to: CGPoint(x: 32, y: 8))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 48, y: 36))
        bezierPath.addLine(to: CGPoint(x: 48, y: 56))
        bezierPath.addLine(to: CGPoint(x: 44, y: 56))
        bezierPath.addLine(to: CGPoint(x: 44, y: 8))
        bezierPath.addLine(to: CGPoint(x: 46, y: 8))
        bezierPath.addLine(to: CGPoint(x: 64, y: 8))
        bezierPath.addLine(to: CGPoint(x: 64, y: 12))
        bezierPath.addLine(to: CGPoint(x: 48, y: 12))
        bezierPath.addLine(to: CGPoint(x: 48, y: 32))
        bezierPath.addLine(to: CGPoint(x: 60, y: 32))
        bezierPath.addLine(to: CGPoint(x: 60, y: 36))
        bezierPath.addLine(to: CGPoint(x: 48, y: 36))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 24, y: 32))
        bezierPath.addLine(to: CGPoint(x: 24, y: 44.79))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 56.8), controlPoint1: CGPoint(x: 24, y: 51.42), controlPoint2: CGPoint(x: 18.61, y: 56.8))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 44.79), controlPoint1: CGPoint(x: 5.37, y: 56.8), controlPoint2: CGPoint(x: 0, y: 51.4))
        bezierPath.addLine(to: CGPoint(x: 0, y: 19.21))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 7.2), controlPoint1: CGPoint(x: 0, y: 12.58), controlPoint2: CGPoint(x: 5.39, y: 7.2))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 19.21), controlPoint1: CGPoint(x: 18.63, y: 7.2), controlPoint2: CGPoint(x: 24, y: 12.6))
        bezierPath.addLine(to: CGPoint(x: 24, y: 20))
        bezierPath.addLine(to: CGPoint(x: 20, y: 20))
        bezierPath.addLine(to: CGPoint(x: 20, y: 19.21))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 11.2), controlPoint1: CGPoint(x: 20, y: 14.8), controlPoint2: CGPoint(x: 16.41, y: 11.2))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 19.21), controlPoint1: CGPoint(x: 7.59, y: 11.2), controlPoint2: CGPoint(x: 4, y: 14.79))
        bezierPath.addLine(to: CGPoint(x: 4, y: 44.79))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 52.8), controlPoint1: CGPoint(x: 4, y: 49.2), controlPoint2: CGPoint(x: 7.59, y: 52.8))
        bezierPath.addCurve(to: CGPoint(x: 20, y: 44.79), controlPoint1: CGPoint(x: 16.41, y: 52.8), controlPoint2: CGPoint(x: 20, y: 49.21))
        bezierPath.addLine(to: CGPoint(x: 20, y: 36))
        bezierPath.addLine(to: CGPoint(x: 12, y: 36))
        bezierPath.addLine(to: CGPoint(x: 12, y: 32))
        bezierPath.addLine(to: CGPoint(x: 24, y: 32))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        color.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x648_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 32, y: 4))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 24), controlPoint1: CGPoint(x: 20.95, y: 4), controlPoint2: CGPoint(x: 12, y: 12.95))
        bezierPath.addCurve(to: CGPoint(x: 23.04, y: 50.4), controlPoint1: CGPoint(x: 12, y: 33.41), controlPoint2: CGPoint(x: 16.11, y: 42.31))
        bezierPath.addCurve(to: CGPoint(x: 30.81, y: 58.05), controlPoint1: CGPoint(x: 25.51, y: 53.28), controlPoint2: CGPoint(x: 28.16, y: 55.84))
        bezierPath.addCurve(to: CGPoint(x: 34.22, y: 60.67), controlPoint1: CGPoint(x: 32.38, y: 59.36), controlPoint2: CGPoint(x: 33.58, y: 60.25))
        bezierPath.addLine(to: CGPoint(x: 29.78, y: 60.67))
        bezierPath.addCurve(to: CGPoint(x: 33.19, y: 58.05), controlPoint1: CGPoint(x: 30.42, y: 60.25), controlPoint2: CGPoint(x: 31.62, y: 59.36))
        bezierPath.addCurve(to: CGPoint(x: 40.96, y: 50.4), controlPoint1: CGPoint(x: 35.84, y: 55.84), controlPoint2: CGPoint(x: 38.49, y: 53.28))
        bezierPath.addCurve(to: CGPoint(x: 52, y: 24), controlPoint1: CGPoint(x: 47.89, y: 42.31), controlPoint2: CGPoint(x: 52, y: 33.41))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 4), controlPoint1: CGPoint(x: 52, y: 12.95), controlPoint2: CGPoint(x: 43.05, y: 4))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 64))
        bezierPath.addCurve(to: CGPoint(x: 8, y: 24), controlPoint1: CGPoint(x: 32, y: 64), controlPoint2: CGPoint(x: 8, y: 48))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 0), controlPoint1: CGPoint(x: 8, y: 10.75), controlPoint2: CGPoint(x: 18.75, y: 0))
        bezierPath.addCurve(to: CGPoint(x: 56, y: 24), controlPoint1: CGPoint(x: 45.25, y: 0), controlPoint2: CGPoint(x: 56, y: 10.75))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 64), controlPoint1: CGPoint(x: 56, y: 48), controlPoint2: CGPoint(x: 32, y: 64))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 40, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 16), controlPoint1: CGPoint(x: 40, y: 19.58), controlPoint2: CGPoint(x: 36.42, y: 16))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 24), controlPoint1: CGPoint(x: 27.58, y: 16), controlPoint2: CGPoint(x: 24, y: 19.58))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 32), controlPoint1: CGPoint(x: 24, y: 28.42), controlPoint2: CGPoint(x: 27.58, y: 32))
        bezierPath.addCurve(to: CGPoint(x: 40, y: 24), controlPoint1: CGPoint(x: 36.42, y: 32), controlPoint2: CGPoint(x: 40, y: 28.42))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 20, y: 24))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 12), controlPoint1: CGPoint(x: 20, y: 17.37), controlPoint2: CGPoint(x: 25.37, y: 12))
        bezierPath.addCurve(to: CGPoint(x: 44, y: 24), controlPoint1: CGPoint(x: 38.63, y: 12), controlPoint2: CGPoint(x: 44, y: 17.37))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 36), controlPoint1: CGPoint(x: 44, y: 30.63), controlPoint2: CGPoint(x: 38.63, y: 36))
        bezierPath.addCurve(to: CGPoint(x: 20, y: 24), controlPoint1: CGPoint(x: 25.37, y: 36), controlPoint2: CGPoint(x: 20, y: 30.63))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x637_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 51.55, y: 8.64))
        bezierPath.addCurve(to: CGPoint(x: 55.36, y: 8.64), controlPoint1: CGPoint(x: 52.6, y: 7.59), controlPoint2: CGPoint(x: 54.31, y: 7.59))
        bezierPath.addCurve(to: CGPoint(x: 55.36, y: 12.45), controlPoint1: CGPoint(x: 56.41, y: 9.69), controlPoint2: CGPoint(x: 56.41, y: 11.4))
        bezierPath.addLine(to: CGPoint(x: 46.16, y: 21.64))
        bezierPath.addCurve(to: CGPoint(x: 42.36, y: 21.64), controlPoint1: CGPoint(x: 45.11, y: 22.7), controlPoint2: CGPoint(x: 43.41, y: 22.7))
        bezierPath.addCurve(to: CGPoint(x: 42.36, y: 17.84), controlPoint1: CGPoint(x: 41.31, y: 20.59), controlPoint2: CGPoint(x: 41.31, y: 18.89))
        bezierPath.addLine(to: CGPoint(x: 51.55, y: 8.64))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 12.45, y: 55.36))
        bezierPath.addCurve(to: CGPoint(x: 8.64, y: 55.36), controlPoint1: CGPoint(x: 11.4, y: 56.41), controlPoint2: CGPoint(x: 9.69, y: 56.41))
        bezierPath.addCurve(to: CGPoint(x: 8.64, y: 51.55), controlPoint1: CGPoint(x: 7.59, y: 54.31), controlPoint2: CGPoint(x: 7.59, y: 52.6))
        bezierPath.addLine(to: CGPoint(x: 17.84, y: 42.36))
        bezierPath.addCurve(to: CGPoint(x: 21.64, y: 42.36), controlPoint1: CGPoint(x: 18.89, y: 41.3), controlPoint2: CGPoint(x: 20.59, y: 41.3))
        bezierPath.addCurve(to: CGPoint(x: 21.64, y: 46.16), controlPoint1: CGPoint(x: 22.69, y: 43.41), controlPoint2: CGPoint(x: 22.69, y: 45.11))
        bezierPath.addLine(to: CGPoint(x: 12.45, y: 55.36))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 62, y: 37.25))
        bezierPath.addCurve(to: CGPoint(x: 63.91, y: 40.55), controlPoint1: CGPoint(x: 63.44, y: 37.64), controlPoint2: CGPoint(x: 64.29, y: 39.11))
        bezierPath.addCurve(to: CGPoint(x: 60.61, y: 42.45), controlPoint1: CGPoint(x: 63.52, y: 41.99), controlPoint2: CGPoint(x: 62.05, y: 42.84))
        bezierPath.addLine(to: CGPoint(x: 48.05, y: 39.09))
        bezierPath.addCurve(to: CGPoint(x: 46.15, y: 35.79), controlPoint1: CGPoint(x: 46.61, y: 38.7), controlPoint2: CGPoint(x: 45.76, y: 37.23))
        bezierPath.addCurve(to: CGPoint(x: 49.44, y: 33.89), controlPoint1: CGPoint(x: 46.53, y: 34.35), controlPoint2: CGPoint(x: 48.01, y: 33.5))
        bezierPath.addLine(to: CGPoint(x: 62, y: 37.25))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 2, y: 26.75))
        bezierPath.addCurve(to: CGPoint(x: 0.09, y: 23.45), controlPoint1: CGPoint(x: 0.56, y: 26.36), controlPoint2: CGPoint(x: -0.29, y: 24.89))
        bezierPath.addCurve(to: CGPoint(x: 3.39, y: 21.55), controlPoint1: CGPoint(x: 0.48, y: 22.01), controlPoint2: CGPoint(x: 1.95, y: 21.16))
        bezierPath.addLine(to: CGPoint(x: 15.95, y: 24.91))
        bezierPath.addCurve(to: CGPoint(x: 17.85, y: 28.21), controlPoint1: CGPoint(x: 17.39, y: 25.3), controlPoint2: CGPoint(x: 18.24, y: 26.77))
        bezierPath.addCurve(to: CGPoint(x: 14.56, y: 30.11), controlPoint1: CGPoint(x: 17.47, y: 29.65), controlPoint2: CGPoint(x: 15.99, y: 30.5))
        bezierPath.addLine(to: CGPoint(x: 2, y: 26.75))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 42.45, y: 60.61))
        bezierPath.addCurve(to: CGPoint(x: 40.55, y: 63.91), controlPoint1: CGPoint(x: 42.84, y: 62.05), controlPoint2: CGPoint(x: 41.99, y: 63.52))
        bezierPath.addCurve(to: CGPoint(x: 37.25, y: 62), controlPoint1: CGPoint(x: 39.11, y: 64.29), controlPoint2: CGPoint(x: 37.64, y: 63.44))
        bezierPath.addLine(to: CGPoint(x: 33.89, y: 49.44))
        bezierPath.addCurve(to: CGPoint(x: 35.79, y: 46.15), controlPoint1: CGPoint(x: 33.5, y: 48.01), controlPoint2: CGPoint(x: 34.35, y: 46.53))
        bezierPath.addCurve(to: CGPoint(x: 39.09, y: 48.05), controlPoint1: CGPoint(x: 37.23, y: 45.76), controlPoint2: CGPoint(x: 38.7, y: 46.61))
        bezierPath.addLine(to: CGPoint(x: 42.45, y: 60.61))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 21.55, y: 3.39))
        bezierPath.addCurve(to: CGPoint(x: 23.45, y: 0.09), controlPoint1: CGPoint(x: 21.16, y: 1.95), controlPoint2: CGPoint(x: 22.01, y: 0.48))
        bezierPath.addCurve(to: CGPoint(x: 26.75, y: 2), controlPoint1: CGPoint(x: 24.89, y: -0.29), controlPoint2: CGPoint(x: 26.36, y: 0.56))
        bezierPath.addLine(to: CGPoint(x: 30.11, y: 14.56))
        bezierPath.addCurve(to: CGPoint(x: 28.21, y: 17.85), controlPoint1: CGPoint(x: 30.5, y: 15.99), controlPoint2: CGPoint(x: 29.65, y: 17.47))
        bezierPath.addCurve(to: CGPoint(x: 24.91, y: 15.95), controlPoint1: CGPoint(x: 26.77, y: 18.24), controlPoint2: CGPoint(x: 25.3, y: 17.39))
        bezierPath.addLine(to: CGPoint(x: 21.55, y: 3.39))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        color.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x735_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 12, y: 28))
        bezierPath.addLine(to: CGPoint(x: 46, y: 28))
        bezierPath.addCurve(to: CGPoint(x: 46.73, y: 35.93), controlPoint1: CGPoint(x: 50.87, y: 28), controlPoint2: CGPoint(x: 51.51, y: 35.05))
        bezierPath.addLine(to: CGPoint(x: 12, y: 42.33))
        bezierPath.addLine(to: CGPoint(x: 12, y: 54.06))
        bezierPath.addCurve(to: CGPoint(x: 14.37, y: 55.52), controlPoint1: CGPoint(x: 12, y: 56.18), controlPoint2: CGPoint(x: 12.5, y: 56.48))
        bezierPath.addLine(to: CGPoint(x: 58.79, y: 32.66))
        bezierPath.addCurve(to: CGPoint(x: 58.79, y: 31.33), controlPoint1: CGPoint(x: 60.41, y: 31.82), controlPoint2: CGPoint(x: 60.4, y: 32.16))
        bezierPath.addLine(to: CGPoint(x: 14.37, y: 8.47))
        bezierPath.addCurve(to: CGPoint(x: 12, y: 9.93), controlPoint1: CGPoint(x: 12.53, y: 7.52), controlPoint2: CGPoint(x: 12, y: 7.84))
        bezierPath.addLine(to: CGPoint(x: 12, y: 28))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 46, y: 32))
        bezierPath.addLine(to: CGPoint(x: 8, y: 32))
        bezierPath.addLine(to: CGPoint(x: 8, y: 9.93))
        bezierPath.addCurve(to: CGPoint(x: 16.2, y: 4.91), controlPoint1: CGPoint(x: 8, y: 4.83), controlPoint2: CGPoint(x: 11.71, y: 2.6))
        bezierPath.addLine(to: CGPoint(x: 60.62, y: 27.77))
        bezierPath.addCurve(to: CGPoint(x: 60.62, y: 36.21), controlPoint1: CGPoint(x: 65.15, y: 30.11), controlPoint2: CGPoint(x: 65.11, y: 33.9))
        bezierPath.addLine(to: CGPoint(x: 16.2, y: 59.08))
        bezierPath.addCurve(to: CGPoint(x: 8, y: 54.06), controlPoint1: CGPoint(x: 11.67, y: 61.4), controlPoint2: CGPoint(x: 8, y: 59.19))
        bezierPath.addLine(to: CGPoint(x: 8, y: 39))
        bezierPath.addLine(to: CGPoint(x: 24.29, y: 36))
        bezierPath.addLine(to: CGPoint(x: 46, y: 32))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x659_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 51.26, y: 52.18))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 60), controlPoint1: CGPoint(x: 46.16, y: 57.14), controlPoint2: CGPoint(x: 39.32, y: 60))
        bezierPath.addCurve(to: CGPoint(x: 12.74, y: 52.18), controlPoint1: CGPoint(x: 24.68, y: 60), controlPoint2: CGPoint(x: 17.84, y: 57.14))
        bezierPath.addLine(to: CGPoint(x: 15.18, y: 49.7))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 56.5), controlPoint1: CGPoint(x: 19.63, y: 54.01), controlPoint2: CGPoint(x: 25.62, y: 56.5))
        bezierPath.addCurve(to: CGPoint(x: 48.82, y: 49.7), controlPoint1: CGPoint(x: 38.38, y: 56.5), controlPoint2: CGPoint(x: 44.37, y: 54.01))
        bezierPath.addLine(to: CGPoint(x: 51.26, y: 52.18))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 50.19, y: 45.43))
        bezierPath.addCurve(to: CGPoint(x: 47.32, y: 45.52), controlPoint1: CGPoint(x: 49.38, y: 44.62), controlPoint2: CGPoint(x: 48.07, y: 44.66))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 52.5), controlPoint1: CGPoint(x: 43.5, y: 49.92), controlPoint2: CGPoint(x: 37.96, y: 52.5))
        bezierPath.addCurve(to: CGPoint(x: 16.68, y: 45.52), controlPoint1: CGPoint(x: 26.04, y: 52.5), controlPoint2: CGPoint(x: 20.5, y: 49.92))
        bezierPath.addCurve(to: CGPoint(x: 13.81, y: 45.43), controlPoint1: CGPoint(x: 15.93, y: 44.66), controlPoint2: CGPoint(x: 14.62, y: 44.62))
        bezierPath.addLine(to: CGPoint(x: 8.58, y: 50.74))
        bezierPath.addCurve(to: CGPoint(x: 8.51, y: 53.5), controlPoint1: CGPoint(x: 7.83, y: 51.5), controlPoint2: CGPoint(x: 7.8, y: 52.71))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 64), controlPoint1: CGPoint(x: 14.46, y: 60.14), controlPoint2: CGPoint(x: 22.92, y: 64))
        bezierPath.addCurve(to: CGPoint(x: 55.49, y: 53.5), controlPoint1: CGPoint(x: 41.08, y: 64), controlPoint2: CGPoint(x: 49.54, y: 60.14))
        bezierPath.addCurve(to: CGPoint(x: 55.42, y: 50.74), controlPoint1: CGPoint(x: 56.2, y: 52.71), controlPoint2: CGPoint(x: 56.17, y: 51.5))
        bezierPath.addLine(to: CGPoint(x: 50.19, y: 45.43))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 49))
        bezierPath.addCurve(to: CGPoint(x: 48.75, y: 32.25), controlPoint1: CGPoint(x: 41.24, y: 49), controlPoint2: CGPoint(x: 48.75, y: 41.49))
        bezierPath.addLine(to: CGPoint(x: 48.75, y: 16.75))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 0), controlPoint1: CGPoint(x: 48.75, y: 7.51), controlPoint2: CGPoint(x: 41.24, y: 0))
        bezierPath.addCurve(to: CGPoint(x: 15.25, y: 16.75), controlPoint1: CGPoint(x: 22.76, y: 0), controlPoint2: CGPoint(x: 15.25, y: 7.51))
        bezierPath.addLine(to: CGPoint(x: 15.25, y: 32.25))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 49), controlPoint1: CGPoint(x: 15.25, y: 41.49), controlPoint2: CGPoint(x: 22.76, y: 49))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 32, y: 45))
        bezierPath.addCurve(to: CGPoint(x: 19.19, y: 32.25), controlPoint1: CGPoint(x: 24.92, y: 45), controlPoint2: CGPoint(x: 19.19, y: 39.27))
        bezierPath.addLine(to: CGPoint(x: 19.19, y: 16.75))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 4), controlPoint1: CGPoint(x: 19.19, y: 9.73), controlPoint2: CGPoint(x: 24.92, y: 4))
        bezierPath.addCurve(to: CGPoint(x: 44.81, y: 16.75), controlPoint1: CGPoint(x: 39.08, y: 4), controlPoint2: CGPoint(x: 44.81, y: 9.73))
        bezierPath.addLine(to: CGPoint(x: 44.81, y: 32.25))
        bezierPath.addCurve(to: CGPoint(x: 32, y: 45), controlPoint1: CGPoint(x: 44.81, y: 39.27), controlPoint2: CGPoint(x: 39.08, y: 45))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }

    @objc dynamic public class func drawIcon_0x679_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 29.59, y: 63.97))
        bezierPath.addCurve(to: CGPoint(x: 26.49, y: 61.73), controlPoint1: CGPoint(x: 28.1, y: 64.19), controlPoint2: CGPoint(x: 26.72, y: 63.19))
        bezierPath.addCurve(to: CGPoint(x: 28.76, y: 58.68), controlPoint1: CGPoint(x: 26.27, y: 60.27), controlPoint2: CGPoint(x: 27.28, y: 58.91))
        bezierPath.addCurve(to: CGPoint(x: 52.56, y: 50.43), controlPoint1: CGPoint(x: 35.21, y: 57.7), controlPoint2: CGPoint(x: 45.62, y: 54.09))
        bezierPath.addCurve(to: CGPoint(x: 57.8, y: 47.54), controlPoint1: CGPoint(x: 52.71, y: 50.36), controlPoint2: CGPoint(x: 57.49, y: 47.88))
        bezierPath.addCurve(to: CGPoint(x: 47.12, y: 48.14), controlPoint1: CGPoint(x: 57.9, y: 45.34), controlPoint2: CGPoint(x: 53.98, y: 46.58))
        bezierPath.addCurve(to: CGPoint(x: 34.93, y: 51.12), controlPoint1: CGPoint(x: 43.1, y: 49.06), controlPoint2: CGPoint(x: 38.95, y: 50.04))
        bezierPath.addCurve(to: CGPoint(x: 32.53, y: 51.75), controlPoint1: CGPoint(x: 33.97, y: 51.37), controlPoint2: CGPoint(x: 33.23, y: 51.57))
        bezierPath.addCurve(to: CGPoint(x: 11.38, y: 55.58), controlPoint1: CGPoint(x: 21.83, y: 54.57), controlPoint2: CGPoint(x: 16.17, y: 55.61))
        bezierPath.addCurve(to: CGPoint(x: 0.62, y: 45.26), controlPoint1: CGPoint(x: 3.63, y: 55.52), controlPoint2: CGPoint(x: -0.29, y: 51.88))
        bezierPath.addCurve(to: CGPoint(x: 30.2, y: 33.76), controlPoint1: CGPoint(x: 1.4, y: 39.52), controlPoint2: CGPoint(x: 5.7, y: 37.83))
        bezierPath.addCurve(to: CGPoint(x: 31.68, y: 33.52), controlPoint1: CGPoint(x: 30.66, y: 33.69), controlPoint2: CGPoint(x: 31.22, y: 33.59))
        bezierPath.addCurve(to: CGPoint(x: 51.48, y: 29.47), controlPoint1: CGPoint(x: 42.6, y: 31.7), controlPoint2: CGPoint(x: 47.24, y: 30.76))
        bezierPath.addCurve(to: CGPoint(x: 53.98, y: 28.62), controlPoint1: CGPoint(x: 52.35, y: 29.2), controlPoint2: CGPoint(x: 53.18, y: 28.92))
        bezierPath.addCurve(to: CGPoint(x: 53.45, y: 25.57), controlPoint1: CGPoint(x: 55.61, y: 28.02), controlPoint2: CGPoint(x: 55.19, y: 25.6))
        bezierPath.addCurve(to: CGPoint(x: 51.69, y: 25.58), controlPoint1: CGPoint(x: 52.9, y: 25.57), controlPoint2: CGPoint(x: 52.31, y: 25.57))
        bezierPath.addCurve(to: CGPoint(x: 32.17, y: 27.37), controlPoint1: CGPoint(x: 47.37, y: 25.67), controlPoint2: CGPoint(x: 42.4, y: 26.14))
        bezierPath.addCurve(to: CGPoint(x: 30.87, y: 27.53), controlPoint1: CGPoint(x: 31.77, y: 27.42), controlPoint2: CGPoint(x: 31.28, y: 27.48))
        bezierPath.addCurve(to: CGPoint(x: 11.45, y: 29.48), controlPoint1: CGPoint(x: 19.3, y: 28.94), controlPoint2: CGPoint(x: 15.68, y: 29.31))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 24.89), controlPoint1: CGPoint(x: 2.48, y: 29.85), controlPoint2: CGPoint(x: 0, y: 28.86))
        bezierPath.addCurve(to: CGPoint(x: 29.76, y: 11.86), controlPoint1: CGPoint(x: -0, y: 18.94), controlPoint2: CGPoint(x: 5.17, y: 16.66))
        bezierPath.addCurve(to: CGPoint(x: 55.12, y: 6.62), controlPoint1: CGPoint(x: 30.76, y: 11.67), controlPoint2: CGPoint(x: 53.62, y: 8.21))
        bezierPath.addCurve(to: CGPoint(x: 35.97, y: 5.5), controlPoint1: CGPoint(x: 56.63, y: 5.03), controlPoint2: CGPoint(x: 36.95, y: 5.46))
        bezierPath.addCurve(to: CGPoint(x: 5.35, y: 10.74), controlPoint1: CGPoint(x: 23.3, y: 6), controlPoint2: CGPoint(x: 11.22, y: 8.03))
        bezierPath.addCurve(to: CGPoint(x: 1.73, y: 9.44), controlPoint1: CGPoint(x: 3.99, y: 11.37), controlPoint2: CGPoint(x: 2.37, y: 10.79))
        bezierPath.addCurve(to: CGPoint(x: 3.05, y: 5.9), controlPoint1: CGPoint(x: 1.11, y: 8.11), controlPoint2: CGPoint(x: 1.69, y: 6.52))
        bezierPath.addCurve(to: CGPoint(x: 35.75, y: 0.15), controlPoint1: CGPoint(x: 9.61, y: 2.87), controlPoint2: CGPoint(x: 22.16, y: 0.69))
        bezierPath.addCurve(to: CGPoint(x: 60.52, y: 5.28), controlPoint1: CGPoint(x: 52.53, y: -0.52), controlPoint2: CGPoint(x: 59.78, y: 1.01))
        bezierPath.addCurve(to: CGPoint(x: 39.96, y: 15.33), controlPoint1: CGPoint(x: 61.37, y: 10.17), controlPoint2: CGPoint(x: 58.52, y: 11.61))
        bezierPath.addCurve(to: CGPoint(x: 30.82, y: 17.11), controlPoint1: CGPoint(x: 38.7, y: 15.58), controlPoint2: CGPoint(x: 31.81, y: 16.91))
        bezierPath.addCurve(to: CGPoint(x: 7.86, y: 21.81), controlPoint1: CGPoint(x: 22.81, y: 18.67), controlPoint2: CGPoint(x: 11.62, y: 20.7))
        bezierPath.addCurve(to: CGPoint(x: 8.43, y: 24.89), controlPoint1: CGPoint(x: 6.05, y: 22.34), controlPoint2: CGPoint(x: 6.55, y: 25.04))
        bezierPath.addCurve(to: CGPoint(x: 30.21, y: 22.22), controlPoint1: CGPoint(x: 11.54, y: 24.64), controlPoint2: CGPoint(x: 21.81, y: 23.24))
        bezierPath.addCurve(to: CGPoint(x: 31.51, y: 22.07), controlPoint1: CGPoint(x: 30.61, y: 22.18), controlPoint2: CGPoint(x: 31.1, y: 22.12))
        bezierPath.addCurve(to: CGPoint(x: 51.57, y: 20.24), controlPoint1: CGPoint(x: 42, y: 20.8), controlPoint2: CGPoint(x: 47.03, y: 20.33))
        bezierPath.addCurve(to: CGPoint(x: 63.66, y: 25.12), controlPoint1: CGPoint(x: 60.25, y: 20.05), controlPoint2: CGPoint(x: 63.27, y: 21.27))
        bezierPath.addCurve(to: CGPoint(x: 53.09, y: 34.57), controlPoint1: CGPoint(x: 64.1, y: 29.38), controlPoint2: CGPoint(x: 60.95, y: 32.17))
        bezierPath.addCurve(to: CGPoint(x: 32.58, y: 38.79), controlPoint1: CGPoint(x: 48.56, y: 35.96), controlPoint2: CGPoint(x: 43.87, y: 36.92))
        bezierPath.addCurve(to: CGPoint(x: 31.1, y: 39.04), controlPoint1: CGPoint(x: 32.12, y: 38.87), controlPoint2: CGPoint(x: 31.57, y: 38.96))
        bezierPath.addCurve(to: CGPoint(x: 12.89, y: 42.66), controlPoint1: CGPoint(x: 21.04, y: 40.71), controlPoint2: CGPoint(x: 16.85, y: 41.53))
        bezierPath.addCurve(to: CGPoint(x: 6.36, y: 45.95), controlPoint1: CGPoint(x: 10.45, y: 43.35), controlPoint2: CGPoint(x: 6.64, y: 43.87))
        bezierPath.addCurve(to: CGPoint(x: 11.41, y: 50.23), controlPoint1: CGPoint(x: 5.91, y: 49.23), controlPoint2: CGPoint(x: 6.99, y: 50.2))
        bezierPath.addCurve(to: CGPoint(x: 31.13, y: 46.58), controlPoint1: CGPoint(x: 15.62, y: 50.26), controlPoint2: CGPoint(x: 21.13, y: 49.22))
        bezierPath.addCurve(to: CGPoint(x: 33.51, y: 45.95), controlPoint1: CGPoint(x: 31.82, y: 46.4), controlPoint2: CGPoint(x: 32.55, y: 46.21))
        bezierPath.addCurve(to: CGPoint(x: 57.38, y: 41.62), controlPoint1: CGPoint(x: 49.42, y: 41.71), controlPoint2: CGPoint(x: 53.11, y: 41.03))
        bezierPath.addCurve(to: CGPoint(x: 63.29, y: 48.78), controlPoint1: CGPoint(x: 62.98, y: 42.4), controlPoint2: CGPoint(x: 65.29, y: 45.13))
        bezierPath.addCurve(to: CGPoint(x: 55.12, y: 55.15), controlPoint1: CGPoint(x: 62.21, y: 50.77), controlPoint2: CGPoint(x: 59.63, y: 52.78))
        bezierPath.addCurve(to: CGPoint(x: 29.59, y: 63.97), controlPoint1: CGPoint(x: 47.62, y: 59.1), controlPoint2: CGPoint(x: 36.64, y: 62.89))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        color.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x167_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x736_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 32, y: 12))
        bezierPath.addLine(to: CGPoint(x: 48, y: 12))
        bezierPath.addLine(to: CGPoint(x: 48, y: 8))
        bezierPath.addLine(to: CGPoint(x: 12, y: 8))
        bezierPath.addLine(to: CGPoint(x: 12, y: 12))
        bezierPath.addLine(to: CGPoint(x: 28, y: 12))
        bezierPath.addLine(to: CGPoint(x: 28, y: 56))
        bezierPath.addLine(to: CGPoint(x: 32, y: 56))
        bezierPath.addLine(to: CGPoint(x: 32, y: 12))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 60, y: 0))
        bezierPath.addLine(to: CGPoint(x: 64, y: 0))
        bezierPath.addLine(to: CGPoint(x: 64, y: 64))
        bezierPath.addLine(to: CGPoint(x: 60, y: 64))
    ...
    @objc dynamic public class func drawIcon_0x260_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x234_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x261_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x262_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x263_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x264_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x265_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x266_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Compose Drawing
        let composePath = UIBezierPath()
        composePath.move(to: CGPoint(x: 44, y: 56))
        composePath.addLine(to: CGPoint(x: 44, y: 44))
        composePath.addLine(to: CGPoint(x: 52, y: 36))
        composePath.addLine(to: CGPoint(x: 52, y: 64))
        composePath.addLine(to: CGPoint(x: 0, y: 64))
        composePath.addLine(to: CGPoint(x: 0, y: 0))
        composePath.addLine(to: CGPoint(x: 48, y: 0))
        composePath.addLine(to: CGPoint(x: 40, y: 8))
        composePath.addLine(to: CGPoint(x: 8, y: 8))
        composePath.addLine(to: CGPoint(x: 8, y: 56))
        composePath.addLine(to: CGPoint(x: 44, y: 56))
        composePath.close()
        composePath.move(to: CGPoint(x: 61.11, y: 13.69))
        composePath.addLine(to: CGPoint(x: 54.31, y: 6.89))
        composePath.addLine(to: CGPoint(x: 55.81, y: 5.4))
        composePath.addCurve(to: CGPoint(x: 62.59, y: 5.42), controlPoint1: CGPoint(x: 57.68, y: 3.53), controlPoint2: CGPoint(x: 60.7, y: 3.53))
        composePath.addCurve(to: CGPoint(x: 62.6, y: 12.2), controlPoint1: CGPoint(x: 64.47, y: 7.29), controlPoint2: CGPoint(x: 64.47, y: 10.33))
        composePath.addLine(to: CGPoint(x: 61.11, y: 13.69))
        composePath.close()
        composePath.move(to: CGPoint(x: 32.5, y: 42.3))
        composePath.addLine(to: CGPoint(x: 24, y: 44))
        composePath.addLine(to: CGPoint(x: 25.7, y: 35.5))
        composePath.addLine(to: CGPoint(x: 52.9, y: 8.31))
        composePath.addLine(to: CGPoint(x: 59.7, y: 15.11))
        composePath.addLine(to: CGPoint(x: 32.5, y: 42.3))
        composePath.close()
        composePath.usesEvenOddFillRule = true
        color.setFill()
        composePath.fill()
    }

    @objc dynamic public class func drawIcon_0x267_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Megaphone Drawing
        let megaphonePath = UIBezierPath()
        megaphonePath.move(to: CGPoint(x: 47.81, y: 53.75))
        megaphonePath.addCurve(to: CGPoint(x: 39.98, y: 60), controlPoint1: CGPoint(x: 47.01, y: 57.33), controlPoint2: CGPoint(x: 43.84, y: 60))
        megaphonePath.addLine(to: CGPoint(x: 28.02, y: 60))
        megaphonePath.addCurve(to: CGPoint(x: 20, y: 51.98), controlPoint1: CGPoint(x: 23.59, y: 60), controlPoint2: CGPoint(x: 20, y: 56.44))
        megaphonePath.addLine(to: CGPoint(x: 20, y: 43.02))
        megaphonePath.addLine(to: CGPoint(x: 12, y: 39.93))
        megaphonePath.addLine(to: CGPoint(x: 3.8, y: 42.68))
        megaphonePath.addCurve(to: CGPoint(x: 0, y: 39.97), controlPoint1: CGPoint(x: 1.7, y: 43.38), controlPoint2: CGPoint(x: 0, y: 42.14))
        megaphonePath.addLine(to: CGPoint(x: 0, y: 23.84))
        megaphonePath.addCurve(to: CGPoint(x: 3.8, y: 21.13), controlPoint1: CGPoint(x: 0, y: 21.64), controlPoint2: CGPoint(x: 1.67, y: 20.42))
        megaphonePath.addLine(to: CGPoint(x: 12, y: 23.88))
        megaphonePath.addLine(to: CGPoint(x: 60.26, y: 5.25))
        megaphonePath.addCurve(to: CGPoint(x: 64, y: 7.85), controlPoint1: CGPoint(x: 62.33, y: 4.45), controlPoint2: CGPoint(x: 64, y: 5.61))
        megaphonePath.addLine(to: CGPoint(x: 64, y: 55.96))
        megaphonePath.addCurve(to: CGPoint(x: 60.26, y: 58.56), controlPoint1: CGPoint(x: 64, y: 58.19), controlPoint2: CGPoint(x: 62.33, y: 59.36))
        megaphonePath.addLine(to: CGPoint(x: 47.81, y: 53.75))
        megaphonePath.close()
        megaphonePath.move(to: CGPoint(x: 24, y: 44.56))
        megaphonePath.addLine(to: CGPoint(x: 24, y: 51.98))
        megaphonePath.addCurve(to: CGPoint(x: 28.02, y: 55.99), controlPoint1: CGPoint(x: 24, y: 54.21), controlPoint2: CGPoint(x: 25.78, y: 55.99))
        megaphonePath.addLine(to: CGPoint(x: 39.98, y: 55.99))
        megaphonePath.addCurve(to: CGPoint(x: 43.99, y: 52.28), controlPoint1: CGPoint(x: 42.13, y: 55.99), controlPoint2: CGPoint(x: 43.84, y: 54.36))
        megaphonePath.addLine(to: CGPoint(x: 24, y: 44.56))
        megaphonePath.close()
        megaphonePath.usesEvenOddFillRule = true
        color.setFill()
        megaphonePath.fill()
    }

    @objc dynamic public class func drawIcon_0x268_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 16, y: 64))
        bezierPath.addCurve(to: CGPoint(x: 8, y: 56), controlPoint1: CGPoint(x: 11.58, y: 64), controlPoint2: CGPoint(x: 8, y: 60.42))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 48), controlPoint1: CGPoint(x: 8, y: 51.58), controlPoint2: CGPoint(x: 11.58, y: 48))
        bezierPath.addCurve(to: CGPoint(x: 24, y: 56), controlPoint1: CGPoint(x: 20.42, y: 48), controlPoint2: CGPoint(x: 24, y: 51.58))
        bezierPath.addCurve(to: CGPoint(x: 16, y: 64), controlPoint1: CGPoint(x: 24, y: 60.42), controlPoint2: CGPoint(x: 20.42, y: 64))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 0, y: 22))
        bezierPath.addCurve(to: CGPoint(x: 22.03, y: 0), controlPoint1: CGPoint(x: 0, y: 9.85), controlPoint2: CGPoint(x: 9.86, y: 0))
        bezierPath.addLine(to: CGPoint(x: 41.97, y: 0))
        bezierPath.addCurve(to: CGPoint(x: 64, y: 22), controlPoint1: CGPoint(x: 54.14, y: 0), controlPoint2: CGPoint(x: 64, y: 9.87))
        bezierPath.addCurve(to: CGPoint(x: 41.97, y: 44), controlPoint1: CGPoint(x: 64, y: 34.15), controlPoint2: CGPoint(x: 54.14, y: 44))
        bezierPath.addLine(to: CGPoint(x: 22.03, y: 44))
        bezierPath.addCurve(to: CGPoint(x: 0, y: 22), controlPoint1: CGPoint(x: 9.86, y: 44), controlPoint2: CGPoint(x: 0, y: 34.13))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        color.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawIcon_0x738_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x739_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x740_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x741_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x742_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x743_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x744_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x745_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x746_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x747_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawIcon_0x269_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {

        //// Group 2
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 11.63, y: 20.01))
        bezierPath.addLine(to: CGPoint(x: 11.63, y: 43.99))
        bezierPath.addLine(to: CGPoint(x: 32, y: 56.05))
        bezierPath.addLine(to: CGPoint(x: 52.37, y: 43.99))
        bezierPath.addLine(to: CGPoint(x: 52.37, y: 20.01))
        bezierPath.addLine(to: CGPoint(x: 32, y: 7.95))
        bezierPath.addLine(to: CGPoint(x: 11.63, y: 20.01))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 28.68, y: 0.81))
        bezierPath.addCurve(to: CGPoint(x: 35.32, y: 0.81), controlPoint1: CGPoint(x: 30.51, y: -0.28), controlPoint2: CGPoint(x: 33.51, y: -0.26))
        bezierPath.addLine(to: CGPoint(x: 56.68, y: 13.46))
        bezierPath.addCurve(to: CGPoint(x: 60, y: 19.36), controlPoint1: CGPoint(x: 58.51, y: 14.54), controlPoint2: CGPoint(x: 60, y: 17.2))
        bezierPath.addLine(to: CGPoint(x: 60, y: 44.64))
        bezierPath.addCurve(to: CGPoint(x: 56.68, y: 50.54), controlPoint1: CGPoint(x: 60, y: 46.82), controlPoint2: CGPoint(x: 58.49, y: 49.47))
        bezierPath.addLine(to: CGPoint(x: 35.32, y: 63.19))
        bezierPath.addCurve(to: CGPoint(x: 28.68, y: 63.19), controlPoint1: CGPoint(x: 33.49, y: 64.28), controlPoint2: CGPoint(x: 30.49, y: 64.26))
        bezierPath.addLine(to: CGPoint(x: 7.32, y: 50.54))
        bezierPath.addCurve(to: CGPoint(x: 4, y: 44.64), controlPoint1: CGPoint(x: 5.49, y: 49.46), controlPoint2: CGPoint(x: 4, y: 46.8))
        bezierPath.addLine(to: CGPoint(x: 4, y: 19.36))
        bezierPath.addCurve(to: CGPoint(x: 7.32, y: 13.46), controlPoint1: CGPoint(x: 4, y: 17.18), controlPoint2: CGPoint(x: 5.51, y: 14.53))
        bezierPath.addLine(to: CGPoint(x: 28.68, y: 0.81))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 36, y: 28))
        bezier2Path.addLine(to: CGPoint(x: 36, y: 20))
        bezier2Path.addLine(to: CGPoint(x: 28, y: 20))
        bezier2Path.addLine(to: CGPoint(x: 28, y: 28))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 28))
        bezier2Path.addLine(to: CGPoint(x: 20, y: 36))
        bezier2Path.addLine(to: CGPoint(x: 28, y: 36))
        bezier2Path.addLine(to: CGPoint(x: 28, y: 44))
        bezier2Path.addLine(to: CGPoint(x: 36, y: 44))
        bezier2Path.addLine(to: CGPoint(x: 36, y: 36))
        bezier2Path.addLine(to: CGPoint(x: 44, y: 36))
        bezier2Path.addLine(to: CGPoint(x: 44, y: 28))
        bezier2Path.addLine(to: CGPoint(x: 36, y: 28))
        bezier2Path.close()
        bezier2Path.usesEvenOddFillRule = true
        color.setFill()
        bezier2Path.fill()
    ...
    @objc dynamic public class func drawIcon_0x748_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x749_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x750_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x751_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x752_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x753_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x754_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x755_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x756_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x757_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawWeek(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawMonth(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawYear(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x758_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x759_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x760_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawIcon_0x761_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawIcon_0x762_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
    ...
    @objc dynamic public class func drawRestore(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 48, height: 48), resizing: ResizingBehavior = .aspectFit, color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfInvite(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
    ...
    @objc dynamic public class func imageOfIcon_0x149_32pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
    ...
    @objc dynamic public class func imageOfSecond(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawSecond(color: color)

        let imageOfSecond = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfSecond
    }

    @objc dynamic public class func imageOfMinute(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawMinute(color: color)

        let imageOfMinute = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfMinute
    }

    @objc dynamic public class func imageOfHour(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawHour(color: color)

        let imageOfHour = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfHour
    }

    @objc dynamic public class func imageOfDay(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawDay(color: color)

        let imageOfDay = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfDay
    }

    @objc dynamic public class func imageOfWeek(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawWeek(color: color)

        let imageOfWeek = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfWeek
    }

    @objc dynamic public class func imageOfMonth(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawMonth(color: color)

        let imageOfMonth = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfMonth
    }

    @objc dynamic public class func imageOfYear(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 64, height: 64), false, 0)
            WireStyleKit.drawYear(color: color)

        let imageOfYear = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc dynamic public class func imageOfRestore(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 48, height: 48), false, 0)
            WireStyleKit.drawRestore(color: color)

        let imageOfRestore = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
