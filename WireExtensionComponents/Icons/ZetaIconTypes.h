...
typedef NS_ENUM(NSInteger, ZetaIconType)
{
    ...
    // 自定义
    // 位图
    ZetaIconTypeSettingAccount                  = 0x4000,
    ZetaIconTypeSettingPhone                    = 0x4001,
    ZetaIconTypeSettingEmail                    = 0x4002,
    ZetaIconTypeSettingAccountManager           = 0x4003,
    ZetaIconTypeSettingSetting                  = 0x4004,
    ZetaIconTypeDarwinRobot                     = 0x4005,//达尔文
    ZetaIconTypeLock                            = 0x4006,
    ZetaIconTypePngCallAudio                    = 0x4007,
    ZetaIconTypePngCallVideo                    = 0x4008,
    ZetaIconTypeAutoreplyDrawin                 = 0x4009,
    ZetaIconTypeAutoreplyAI                     = 0x4010,
    ZetaIconTypeAutoreplyZuChongZhi             = 0x4011,
    ZetaIconTypeSettingWallet                   = 0x4012,
    
    ZetaIconTypeSettingScanLoginWeb             = 0x4013,
    ZetaIconTypeSettingSecurity                 = 0x4014,
    ZetaIconTypeSettingPhoto                    = 0x4015,
    ZetaIconTypeSecretLogo                      = 0x4016,
    ZetaIconTypeStar                            = 0x4017
